...
df = read_table("temp.ja_blend_mmm2_DigitalDMA").filter( (f.col('media_type')=='Unknown') & (f.col('Traffic_Source')=='Nextdoor') )
...
df = df.withColumn( 'SubChannel', f.lit('Nextdoor'))
...
## Saving Dataframe ##
table_name = "temp.ja_blend_mmm2_Nextdoor"
