...
df = read_table("temp.ja_blend_mmm2_DigitalCampaign").filter( (f.col('media_type')=='Content') & (f.col('Traffic_Source')=='Outbrain') )
...
df = df.withColumn( 'SubChannel', f.lit('Outbrain'))
...
## Saving Dataframe ##
table_name = "temp.ja_blend_mmm2_Outbrain" 
