...
ax2 = ax1.twinx()
ax2.plot(init_brand_equity['WOM_Exposure'], label='WOM_Exposure', color='g')

init_brand_equity['WOM_Exposure_rolling'] = init_brand_equity['WOM_Exposure'].rolling(window=3).mean()
ax2.plot(init_brand_equity['WOM_Exposure_rolling'], label='WOM_Exposure Moving Avg', color='r')
...
corr1 = model_df["base_joins"].corr(init_brand_equity['WOM_Exposure'])
corr2 = joins_df["Joins_unnorm"].corr(init_brand_equity['WOM_Exposure'])
corr3 = model_df["base_joins"].corr(init_brand_equity['WOM_Exposure_rolling'])
corr4 = model_df["base_joins_rolling_avg"].corr(init_brand_equity['WOM_Exposure_rolling'])
corr4
...
## Merging "WOM_Exposure" in it ##
df = df.merge(init_brand_equity[['Date', 'WOM_Exposure_rolling', 'WOM_Exposure']], on='Date', how='left')
...
## Brand Equity Var ##
equity_var_list =['WOM_Exposure_Lag1_AdStock80', 'WOM_Exposure_Lag1_AdStock70', 'WOM_Exposure_Lag1_AdStock50', 'WOM_Exposure_Lag1_AdStock30', 'WOM_Exposure_Lag2_AdStock80', 'WOM_Exposure_Lag2_AdStock70', 'WOM_Exposure_Lag2_AdStock50', 'WOM_Exposure_Lag2_AdStock30', 'WOM_Exposure_Lag3_AdStock80', 'WOM_Exposure_Lag3_AdStock70', 'WOM_Exposure_Lag3_AdStock50', 'WOM_Exposure_Lag3_AdStock30', 'WOM_Exposure_Lag4_AdStock80', 'WOM_Exposure_Lag4_AdStock70', 'WOM_Exposure_Lag4_AdStock50', 'WOM_Exposure_Lag4_AdStock30', 'WOM_Exposure_Lag5_AdStock80', 'WOM_Exposure_Lag5_AdStock70', 'WOM_Exposure_Lag5_AdStock50', 'WOM_Exposure_Lag5_AdStock30', 'WOM_Exposure_Lag6_AdStock80', 'WOM_Exposure_Lag6_AdStock70', 'WOM_Exposure_Lag6_AdStock50', 'WOM_Exposure_Lag6_AdStock30', 'WOM_Exposure_Lag7_AdStock80','WOM_Exposure_Lag7_AdStock70', 'WOM_Exposure_Lag7_AdStock50', 'WOM_Exposure_Lag7_AdStock30', 'WOM_Exposure_Lag8_AdStock80', 'WOM_Exposure_Lag8_AdStock70', 'WOM_Exposure_Lag8_AdStock50', 'WOM_Exposure_Lag8_AdStock30']
...
file_path = '/dbfs/blend360/sandbox/mmm/brand_model/brandmodel_11_02_OrganicJoins_WOM_Exposure.json'
