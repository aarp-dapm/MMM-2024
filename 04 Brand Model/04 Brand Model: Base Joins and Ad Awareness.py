...
ax2 = ax1.twinx()
ax2.plot(init_brand_equity['Ad_Awareness'], label='Ad_Awareness', color='g')

init_brand_equity['Ad_Awareness_rolling'] = init_brand_equity['Ad_Awareness'].rolling(window=3).mean()
ax2.plot(init_brand_equity['Ad_Awareness_rolling'], label='Ad_Awareness Moving Avg', color='r')
...
corr1 = model_df["base_joins"].corr(init_brand_equity['Ad_Awareness'])
corr2 = joins_df["Joins_unnorm"].corr(init_brand_equity['Ad_Awareness'])
corr3 = model_df["base_joins"].corr(init_brand_equity['Ad_Awareness_rolling'])
corr4 = model_df["base_joins_rolling_avg"].corr(init_brand_equity['Ad_Awareness_rolling'])
corr4
...
## Merging "Ad_Awareness" in it ##
df = df.merge(init_brand_equity[['Date', 'Ad_Awareness_rolling', 'Ad_Awareness']], on='Date', how='left')
...
## Brand Equity Var ##
equity_var_list =['Ad_Awareness_Lag1_AdStock80', 'Ad_Awareness_Lag1_AdStock70', 'Ad_Awareness_Lag1_AdStock50', 'Ad_Awareness_Lag1_AdStock30', 'Ad_Awareness_Lag2_AdStock80',
       'Ad_Awareness_Lag2_AdStock70', 'Ad_Awareness_Lag2_AdStock50', 'Ad_Awareness_Lag2_AdStock30', 'Ad_Awareness_Lag3_AdStock80', 'Ad_Awareness_Lag3_AdStock70', 'Ad_Awareness_Lag3_AdStock50',
       'Ad_Awareness_Lag3_AdStock30', 'Ad_Awareness_Lag4_AdStock80', 'Ad_Awareness_Lag4_AdStock70', 'Ad_Awareness_Lag4_AdStock50', 'Ad_Awareness_Lag4_AdStock30', 'Ad_Awareness_Lag5_AdStock80',
       'Ad_Awareness_Lag5_AdStock70', 'Ad_Awareness_Lag5_AdStock50', 'Ad_Awareness_Lag5_AdStock30', 'Ad_Awareness_Lag6_AdStock80', 'Ad_Awareness_Lag6_AdStock70', 'Ad_Awareness_Lag6_AdStock50',
       'Ad_Awareness_Lag6_AdStock30', 'Ad_Awareness_Lag7_AdStock80', 'Ad_Awareness_Lag7_AdStock70', 'Ad_Awareness_Lag7_AdStock50', 'Ad_Awareness_Lag7_AdStock30', 'Ad_Awareness_Lag8_AdStock80',
       'Ad_Awareness_Lag8_AdStock70', 'Ad_Awareness_Lag8_AdStock50', 'Ad_Awareness_Lag8_AdStock30']
...
file_path = '/dbfs/blend360/sandbox/mmm/brand_model/brandmodel_11_02_OrganicJoins_AdAwareness.json'
