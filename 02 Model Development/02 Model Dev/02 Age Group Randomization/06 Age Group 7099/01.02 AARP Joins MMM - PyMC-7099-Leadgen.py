...
coeff = 0.1581 ## Getting this coeff from bayesian model
...
with varying_intercept:
  varying_intercept_trace = pm.sample(draws=3000,tune=100, chains=4, random_seed = RANDOM_SEED, progressbar=True,target_accept=0.90)
...
agg_analysis_df.to_csv('/dbfs/blend360/sandbox/mmm/model/agg_analysis_df_SubModel_Leadgen_7099.csv')

## Read Agg. Analysis Dataframe ##
agg_analysis_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/agg_analysis_df_SubModel_Leadgen_7099.csv').drop('Unnamed: 0',axis=1)
