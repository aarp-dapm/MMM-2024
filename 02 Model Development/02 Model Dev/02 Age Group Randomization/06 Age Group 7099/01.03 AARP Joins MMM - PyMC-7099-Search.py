...
coeff =  0.082 ## Getting this from Bayesian Model
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       # y_hat = intercept_re[dma_idx] + beta_social*social_idx + beta_tv*tv_idx + beta_video*video_idx + beta_Trend*Trend_idx
...
agg_analysis_df.to_csv('/dbfs/blend360/sandbox/mmm/model/agg_analysis_df_SubModel_Search_7099.csv')

## Read Agg. Analysis Dataframe ##
agg_analysis_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/agg_analysis_df_SubModel_Search_7099.csv').drop('Unnamed: 0',axis=1)
