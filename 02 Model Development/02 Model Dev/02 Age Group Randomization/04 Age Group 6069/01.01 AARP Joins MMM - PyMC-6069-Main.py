...
with pm.Model(coords=coords) as varying_intercept:
       ...
       y_like = pm.Normal('y_like', mu= y_hat, sigma=sd_y, observed=model_df['Joins_6069_norm'], dims='obs_id')
...
agg_analysis_df.to_csv('/dbfs/blend360/sandbox/mmm/model/agg_analysis_df_main_model_6069.csv')

## Read Agg. Analysis Dataframe ##
agg_analysis_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/agg_analysis_df_main_model_6069.csv').drop('Unnamed: 0',axis=1)
