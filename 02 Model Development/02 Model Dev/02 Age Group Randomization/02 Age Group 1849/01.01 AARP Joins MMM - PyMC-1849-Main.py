...
contribution = pd.concat([model_df[['DmaCode', 'Date', 'Joins', 'Joins_1849_norm']], contribution], axis=1) ## Change Target Var
...
contribution['Residuals'] = contribution['Joins_1849_norm'] - contribution['Pred']  ## Change Target Var
contribution['ratio_resid_join'] =  contribution['Residuals']/contribution['Joins_1849_norm'] ## Change Target Var
contribution['Year'] = pd.to_datetime(contribution['Date']).dt.year

## Update name ##
contribution.rename(columns={'Joins':'Joins_unnorm', 'Joins_1849_norm':'Joins'}, inplace=True) ## Change Target Var
...
agg_analysis_df.to_csv('/dbfs/blend360/sandbox/mmm/model/agg_analysis_df_main_model_1849.csv')

## Read Agg. Analysis Dataframe ##
agg_analysis_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/agg_analysis_df_main_model_1849.csv').drop('Unnamed: 0',axis=1)
