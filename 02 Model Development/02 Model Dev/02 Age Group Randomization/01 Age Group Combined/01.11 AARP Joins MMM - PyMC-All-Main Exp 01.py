...
'''
Experiment: This experiment involves adjusting priors such that contribution of Dirct Mail reaches ~25% of the total contribution.
'''
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       beta_dm =   pm.Uniform('beta_dm', lower= 0.082*3-0.002,upper=0.082*3+0.002) # 1) increasing coeff value by 3 times such that copntribution is 3 times 2) also changing distribution to Uniform
