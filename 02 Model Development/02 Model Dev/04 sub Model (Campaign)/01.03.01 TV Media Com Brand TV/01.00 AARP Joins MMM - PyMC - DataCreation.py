...
## Reaqding Data ##
rawdata_df=spark.sql('select * from temp.ja_blend_mmm2_MediaDf_Campaign_TV_BrandTV').toPandas()
rawdata_df.display()
...
######### User Input Dict #############
#######################################
cols = ['TV_MediaCom_BrandTV_15_Imps', 'TV_MediaCom_BrandTV_30_Imps', 'TV_MediaCom_BrandTV_60_Imps']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','TV_MediaCom_BrandTV_15_Imps', 'TV_MediaCom_BrandTV_30_Imps', 'TV_MediaCom_BrandTV_60_Imps']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_TV_BrandTV.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_TV_BrandTV.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'TV_MediaCom_BrandTV_15_Spend', 'TV_MediaCom_BrandTV_30_Spend', 'TV_MediaCom_BrandTV_60_Spend' ,'TV_MediaCom_BrandTV_15_Imps', 'TV_MediaCom_BrandTV_30_Imps', 'TV_MediaCom_BrandTV_60_Imps' ,'TV_MediaCom_BrandTV_15_Clicks', 'TV_MediaCom_BrandTV_30_Clicks', 'TV_MediaCom_BrandTV_60_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_TV_BrandTV.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_TV_BrandTV.csv').drop('Unnamed: 0',axis=1)
model_df.head()
