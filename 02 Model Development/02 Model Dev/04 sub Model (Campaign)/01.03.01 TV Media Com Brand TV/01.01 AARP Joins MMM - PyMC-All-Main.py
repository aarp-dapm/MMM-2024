...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_TV_BrandTV.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
for col in model_df.columns:
  if col.startswith('TV_MediaCom_BrandTV') &  col.endswith('_Spend'):
    print(col)
...
model_cols = [
'TV_MediaCom_BrandTV_15_Imps_AdStock6L2Wk70Ad_Power70',
'TV_MediaCom_BrandTV_30_Imps_AdStock6L2Wk70Ad_Power70',
'TV_MediaCom_BrandTV_60_Imps_AdStock6L2Wk70Ad_Power70'
]

data_cols = [
'TV_MediaCom_BrandTV_15_Spend',
'TV_MediaCom_BrandTV_30_Spend',
'TV_MediaCom_BrandTV_60_Spend'
]
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       tv_MediaCom_BrandTV_15_idx = pm.MutableData('tv_MediaCom_BrandTV_15_idx', model_df['TV_MediaCom_BrandTV_15_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       tv_MediaCom_BrandTV_30_idx = pm.MutableData('tv_MediaCom_BrandTV_30_idx', model_df['TV_MediaCom_BrandTV_30_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       tv_MediaCom_BrandTV_60_idx = pm.MutableData('tv_MediaCom_BrandTV_60_idx', model_df['TV_MediaCom_BrandTV_60_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       ...
       beta_MediaCom_BrandTV_15_tv =    pm.Uniform('beta_MediaCom_BrandTV_15_tv', lower = (0.037/4)*0.62-0.002, upper = (0.037/4)*0.62+0.002)
       beta_MediaCom_BrandTV_30_tv =    pm.Uniform('beta_MediaCom_BrandTV_30_tv', lower = (0.037/4)*0.35-0.002, upper = (0.037/4)*0.35+0.002)
       beta_MediaCom_BrandTV_60_tv =    pm.Uniform('beta_MediaCom_BrandTV_60_tv', lower = (0.037/4)*0.02-0.0001, upper = (0.037/4)*0.02+0.0001)
...
'beta_MediaCom_BrandTV_15_tv': 'TV_MediaCom_BrandTV_15_Imps_AdStock6L2Wk70Ad_Power70',
'beta_MediaCom_BrandTV_30_tv': 'TV_MediaCom_BrandTV_30_Imps_AdStock6L2Wk70Ad_Power70',
'beta_MediaCom_BrandTV_60_tv': 'TV_MediaCom_BrandTV_60_Imps_AdStock6L2Wk70Ad_Power70',
