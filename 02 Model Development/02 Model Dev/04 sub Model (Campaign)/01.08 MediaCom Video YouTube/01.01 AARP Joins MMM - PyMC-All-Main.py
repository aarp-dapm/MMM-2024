...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_VideoYT.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
'Video_MediaCom_YouTube_Brand_Imps_AdStock6L4Wk30Ad_Power30', 
'Video_MediaCom_YouTube_NonBrand_Imps_AdStock6L4Wk30Ad_Power30' 
]

data_cols = [

'Video_MediaCom_YouTube_Brand_Spend',
'Video_MediaCom_YouTube_NonBrand_Spend'
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       video_MediaCom_YouTube_Brand_idx = pm.MutableData('video_MediaCom_YouTube_Brand_idx', model_df['Video_MediaCom_YouTube_Brand_Imps_AdStock6L4Wk30Ad_Power30'].values, dims='obs_id')
       video_MediaCom_YouTube_NonBrand_idx = pm.MutableData('video_MediaCom_YouTube_NonBrand_idx', model_df['Video_MediaCom_YouTube_NonBrand_Imps_AdStock6L4Wk30Ad_Power30'].values, dims='obs_id')
       ...
       beta_MediaCom_YouTube_Brand_video =    pm.Uniform('beta_MediaCom_YouTube_Brand_video',  lower= 0.03*0.15-0.003,upper=0.03*0.15+0.003)
       beta_MediaCom_YouTube_NonBrand_video =    pm.Uniform('beta_MediaCom_YouTube_NonBrand_video',  lower= 0.03*0.15*0.10-0.0003,upper=0.03*0.15*0.10+0.0003)
       ...
       y_hat = intercept_re[dma_idx] + beta_tv*tv_idx + beta_social*social_idx + beta_IcmDigital_Native_video*video_IcmDigital_Native_idx + beta_IcmDigital_YouTube_video*video_IcmDigital_YouTube_idx + beta_MediaCom_OLV_video*video_MediaCom_OLV_idx + beta_Trend*Trend_idx + beta_MediaCom_YouTube_Brand_video*video_MediaCom_YouTube_Brand_idx + beta_MediaCom_YouTube_NonBrand_video*video_MediaCom_YouTube_NonBrand_idx
...
map_dict = {
  ...
  'beta_MediaCom_YouTube_Brand_video': 'Video_MediaCom_YouTube_Brand_Imps_AdStock6L4Wk30Ad_Power30',
  'beta_MediaCom_YouTube_NonBrand_video': 'Video_MediaCom_YouTube_NonBrand_Imps_AdStock6L4Wk30Ad_Power30',
