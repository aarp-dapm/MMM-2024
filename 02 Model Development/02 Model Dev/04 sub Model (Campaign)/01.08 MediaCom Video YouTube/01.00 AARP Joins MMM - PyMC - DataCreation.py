...
## Reaqding Data ##
rawdata_df=spark.sql('select * from temp.ja_blend_mmm2_MediaDf_Campaign_MediaCom_VideoYT').toPandas()
rawdata_df.display()

# COMMAND ----------

for col in rawdata_df.columns:
  if col.startswith('Video_MediaCom_YouTube_'):
    print(col)
...
rawdata_df['Video_MediaCom_YouTube_NonBrand_Spend'] = rawdata_df[['Video_MediaCom_YouTube_States_Spend', 'Video_MediaCom_YouTube_TargetedCommunities_Spend']].sum(axis=1)
rawdata_df['Video_MediaCom_YouTube_NonBrand_Imps'] = rawdata_df[['Video_MediaCom_YouTube_States_Imps', 'Video_MediaCom_YouTube_TargetedCommunities_Imps']].sum(axis=1)
rawdata_df['Video_MediaCom_YouTube_NonBrand_Clicks'] = rawdata_df[['Video_MediaCom_YouTube_States_Clicks', 'Video_MediaCom_YouTube_TargetedCommunities_Clicks']].sum(axis=1)
...
cols = ['Video_MediaCom_YouTube_Brand_Imps', 'Video_MediaCom_YouTube_NonBrand_Imps']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','Video_MediaCom_YouTube_Brand_Imps', 'Video_MediaCom_YouTube_NonBrand_Imps']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_MediaCom_VideoYT.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_MediaCom_VideoYT.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Video_MediaCom_YouTube_Brand_Spend', 'Video_MediaCom_YouTube_NonBrand_Spend', 'Video_MediaCom_YouTube_Brand_Imps', 'Video_MediaCom_YouTube_NonBrand_Imps', 'Video_MediaCom_YouTube_Brand_Clicks', 'Video_MediaCom_YouTube_NonBrand_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_VideoYT.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_VideoYT.csv').drop('Unnamed: 0',axis=1)
model_df.head()
