...
## Reaqding Data ##
rawdata_df=spark.sql('select * from temp.ja_blend_mmm2_MediaDf_Campaign_MediaCom_SearchBing').toPandas()
rawdata_df.display()
...
for col in rawdata_df.columns:
  if (col.startswith('Search_MediaCom_Bing_')):
    cols.append(col)
cols
...
######### User Input Dict #############
#######################################
cols = ['Search_MediaCom_Bing_Brand_Clicks', 'Search_MediaCom_Bing_TargetedCommunities_Clicks']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','Search_MediaCom_Bing_Brand_Clicks', 'Search_MediaCom_Bing_TargetedCommunities_Clicks']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_MediaCom_SearchBing.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_MediaCom_SearchBing.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Search_MediaCom_Bing_Brand_Spend', 'Search_MediaCom_Bing_TargetedCommunities_Spend', 'Search_MediaCom_Bing_Brand_Imps', 'Search_MediaCom_Bing_TargetedCommunities_Imps',
 'Search_MediaCom_Bing_Brand_Clicks', 'Search_MediaCom_Bing_TargetedCommunities_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_SearchBing.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_SearchBing.csv').drop('Unnamed: 0',axis=1)
model_df.head()
