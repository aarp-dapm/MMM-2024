...
## Reaqding Data ##
rawdata_df=spark.sql('select * from temp.ja_blend_mmm2_MediaDf_Campaign_MediaCom_Display').filter(f.year(f.col('Date')).isin([2022, 2023])).toPandas()
rawdata_df.display()
...
### Spend ###
rawdata_df['Display_MediaCom_Display_NonBrand_Spend'] = rawdata_df[['Display_MediaCom_Display_Foundation_Spend', 'Display_MediaCom_Display_ODEI_Spend', 'Display_MediaCom_Display_Programs_Spend', 'Display_MediaCom_Display_States_Spend', 'Display_MediaCom_Display_TargetedCommunities_Spend']].sum(axis=1)

### Impressions ###
rawdata_df['Display_MediaCom_Display_NonBrand_Imps'] = rawdata_df[['Display_MediaCom_Display_Foundation_Imps', 'Display_MediaCom_Display_ODEI_Imps', 'Display_MediaCom_Display_Programs_Imps', 'Display_MediaCom_Display_States_Imps', 'Display_MediaCom_Display_TargetedCommunities_Imps']].sum(axis=1)

### Clicks ###
rawdata_df['Display_MediaCom_Display_NonBrand_Clicks'] = rawdata_df[['Display_MediaCom_Display_Foundation_Clicks', 'Display_MediaCom_Display_ODEI_Clicks', 'Display_MediaCom_Display_Programs_Clicks', 'Display_MediaCom_Display_States_Clicks', 'Display_MediaCom_Display_TargetedCommunities_Clicks']].sum(axis=1)
...
for col in rawdata_df.columns:
  if (col.split('_')[0] == 'Display') & (col.split('_')[-1] == 'Imps'):
    cols.append(col)
cols
...
######### User Input Dict #############
#######################################
cols = ['Display_MediaCom_Display_Brand_Imps', 'Display_MediaCom_Display_NonBrand_Imps', 'Display_MediaCom_Display_Foundation_Imps', 'Display_MediaCom_Display_ODEI_Imps', 'Display_MediaCom_Display_Programs_Imps',
 'Display_MediaCom_Display_States_Imps', 'Display_MediaCom_Display_TargetedCommunities_Imps']

input_dict = {}
for col in cols:
  input_dict[col] = {'Adstock':{'week_cutoff':[6], 'peak_week':[1], 'decay_rate': [0.8]}, 'Saturation':{'power':[0.4]}}
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date', 'Display_MediaCom_Display_Brand_Imps', 'Display_MediaCom_Display_NonBrand_Imps', 'Display_MediaCom_Display_Foundation_Imps', 'Display_MediaCom_Display_ODEI_Imps', 'Display_MediaCom_Display_Programs_Imps', 'Display_MediaCom_Display_States_Imps', 'Display_MediaCom_Display_TargetedCommunities_Imps']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_Display_MediaCom.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_Display_MediaCom.csv').drop('Unnamed: 0',axis=1)
...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Display.csv').drop('Unnamed: 0',axis=1)
model_df.head()
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Display_MediaCom_Display_Brand_Spend', 'Display_MediaCom_Display_NonBrand_Spend', 'Display_MediaCom_Display_Foundation_Spend', 'Display_MediaCom_Display_ODEI_Spend', 'Display_MediaCom_Display_Programs_Spend', 'Display_MediaCom_Display_States_Spend', 'Display_MediaCom_Display_TargetedCommunities_Spend', 'Display_MediaCom_Display_Brand_Imps', 'Display_MediaCom_Display_NonBrand_Imps', 'Display_MediaCom_Display_Foundation_Imps', 'Display_MediaCom_Display_ODEI_Imps', 'Display_MediaCom_Display_Programs_Imps', 'Display_MediaCom_Display_States_Imps', 'Display_MediaCom_Display_TargetedCommunities_Imps',   'Display_MediaCom_Display_Brand_Clicks', 'Display_MediaCom_Display_NonBrand_Clicks', 'Display_MediaCom_Display_Foundation_Clicks', 'Display_MediaCom_Display_ODEI_Clicks', 'Display_MediaCom_Display_Programs_Clicks', 'Display_MediaCom_Display_States_Clicks', 'Display_MediaCom_Display_TargetedCommunities_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_Display_MediaCom.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_Display_MediaCom.csv').drop('Unnamed: 0',axis=1)
model_df.head()
