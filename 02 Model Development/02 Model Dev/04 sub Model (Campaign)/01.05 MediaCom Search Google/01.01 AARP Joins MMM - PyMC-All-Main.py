...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_SearchGoogle.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
model_cols = [
'Search_MediaCom_Google_Brand_Clicks_AdStock6L1Wk90Ad_Power90', 'Search_MediaCom_Google_NonBrand_Clicks_AdStock6L1Wk90Ad_Power90'
]

data_cols = [

'Search_MediaCom_Google_Brand_Spend', 'Search_MediaCom_Google_NonBrand_Spend'
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       search_MediaCom_Google_Brand_idx = pm.MutableData('search_MediaCom_Google_Brand_idx', model_df['Search_MediaCom_Google_Brand_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       search_MediaCom_Google_NonBrand_idx = pm.MutableData('search_MediaCom_Google_NonBrand_idx', model_df['Search_MediaCom_Google_NonBrand_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       ...
       beta_MediaCom_Google_Brand_search =  pm.Uniform('beta_MediaCom_Google_Brand_search', lower = 0.085*0.07*0.73*0.29-0.001,upper = 0.085*0.07*0.73*0.29+0.001)
       beta_MediaCom_Google_NonBrand_search =  pm.Uniform('beta_MediaCom_Google_NonBrand_search', lower = 0.085*0.07*0.73*0.71-0.0025,upper = 0.085*0.07*0.73*0.71+0.0025)
...
'beta_MediaCom_Google_Brand_search': 'Search_MediaCom_Google_Brand_Clicks_AdStock6L1Wk90Ad_Power90',
'beta_MediaCom_Google_NonBrand_search': 'Search_MediaCom_Google_NonBrand_Clicks_AdStock6L1Wk90Ad_Power90',
...
'Search_MediaCom_Google_Brand_Clicks_AdStock6L1Wk90Ad_Power90',
'Search_MediaCom_Google_NonBrand_Clicks_AdStock6L1Wk90Ad_Power90',
