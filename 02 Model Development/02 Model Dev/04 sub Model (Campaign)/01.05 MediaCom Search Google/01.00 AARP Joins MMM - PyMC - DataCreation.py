...
## Reaqding Data ##
rawdata_df=spark.sql('select * from temp.ja_blend_mmm2_MediaDf_Campaign_MediaCom_SearchGoogle').toPandas()
rawdata_df.display()
...
## Spend ##
rawdata_df['Search_MediaCom_Google_NonBrand_Spend'] = rawdata_df[['Search_MediaCom_Google_MediaAdvertisingNetwork_Spend', 'Search_MediaCom_Google_ODEI_Spend',
                                                                  'Search_MediaCom_Google_States_Spend', 'Search_MediaCom_Google_TargetedCommunities_Spend']].sum(axis=1)

## Imps ##
rawdata_df['Search_MediaCom_Google_NonBrand_Imps'] = rawdata_df[['Search_MediaCom_Google_MediaAdvertisingNetwork_Imps', 'Search_MediaCom_Google_ODEI_Imps',
                                                                  'Search_MediaCom_Google_States_Imps', 'Search_MediaCom_Google_TargetedCommunities_Imps']].sum(axis=1)

## Imps ##
rawdata_df['Search_MediaCom_Google_NonBrand_Clicks'] = rawdata_df[['Search_MediaCom_Google_MediaAdvertisingNetwork_Clicks', 'Search_MediaCom_Google_ODEI_Clicks',
                                                                  'Search_MediaCom_Google_States_Clicks', 'Search_MediaCom_Google_TargetedCommunities_Clicks']].sum(axis=1)
...
for col in rawdata_df.columns:
  if (col.startswith('Search_MediaCom_Google_')):
    cols.append(col)
cols
...
######### User Input Dict #############
#######################################
cols = ['Search_MediaCom_Google_Brand_Clicks', 'Search_MediaCom_Google_MediaAdvertisingNetwork_Clicks', 'Search_MediaCom_Google_ODEI_Clicks', 'Search_MediaCom_Google_States_Clicks', 'Search_MediaCom_Google_TargetedCommunities_Clicks', 'Search_MediaCom_Google_NonBrand_Clicks']

input_dict = {}
for col in cols:
  input_dict[col] = {'Adstock':{'week_cutoff':[6], 'peak_week':[1], 'decay_rate': [0.9]}, 'Saturation':{'power':[0.9]}}
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','Search_MediaCom_Google_Brand_Clicks', 'Search_MediaCom_Google_MediaAdvertisingNetwork_Clicks', 'Search_MediaCom_Google_ODEI_Clicks', 'Search_MediaCom_Google_States_Clicks', 'Search_MediaCom_Google_TargetedCommunities_Clicks', 'Search_MediaCom_Google_NonBrand_Clicks']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_MediaCom_SearchGoogle.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_MediaCom_SearchGoogle.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Search_MediaCom_Google_Brand_Spend', 'Search_MediaCom_Google_NonBrand_Spend', 'Search_MediaCom_Google_MediaAdvertisingNetwork_Spend', 'Search_MediaCom_Google_ODEI_Spend', 'Search_MediaCom_Google_States_Spend', 'Search_MediaCom_Google_TargetedCommunities_Spend', 'Search_MediaCom_Google_Brand_Imps','Search_MediaCom_Google_NonBrand_Imps', 'Search_MediaCom_Google_MediaAdvertisingNetwork_Imps', 'Search_MediaCom_Google_ODEI_Imps', 'Search_MediaCom_Google_States_Imps', 'Search_MediaCom_Google_TargetedCommunities_Imps', 'Search_MediaCom_Google_Brand_Clicks', 'Search_MediaCom_Google_NonBrand_Clicks', 'Search_MediaCom_Google_MediaAdvertisingNetwork_Clicks', 'Search_MediaCom_Google_ODEI_Clicks', 'Search_MediaCom_Google_States_Clicks', 'Search_MediaCom_Google_TargetedCommunities_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_SearchGoogle.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_SearchGoogle.csv').drop('Unnamed: 0',axis=1)
model_df.head()
