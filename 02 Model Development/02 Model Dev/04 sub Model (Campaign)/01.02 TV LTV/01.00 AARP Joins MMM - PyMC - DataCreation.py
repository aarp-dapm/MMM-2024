...
## Reaqding Data ##
rawdata_df=spark.sql('select * from temp.ja_blend_mmm2_MediaDf_Campaign_TV_LTV').toPandas()
rawdata_df.display()
...
######### User Input Dict #############
#######################################
cols = ['TV_DRTV_LinearTV_10_Imps', 'TV_DRTV_LinearTV_120_Imps', 'TV_DRTV_LinearTV_15_Imps', 'TV_DRTV_LinearTV_30_Imps', 'TV_DRTV_LinearTV_60_Imps']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','TV_DRTV_LinearTV_10_Imps', 'TV_DRTV_LinearTV_120_Imps', 'TV_DRTV_LinearTV_15_Imps', 'TV_DRTV_LinearTV_30_Imps', 'TV_DRTV_LinearTV_60_Imps']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_TV_LTV.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_TV_LTV.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'TV_DRTV_LinearTV_10_Spend', 'TV_DRTV_LinearTV_120_Spend', 'TV_DRTV_LinearTV_15_Spend', 'TV_DRTV_LinearTV_30_Spend', 'TV_DRTV_LinearTV_60_Spend', 'TV_DRTV_LinearTV_10_Imps', 'TV_DRTV_LinearTV_120_Imps', 'TV_DRTV_LinearTV_15_Imps', 'TV_DRTV_LinearTV_30_Imps', 'TV_DRTV_LinearTV_60_Imps', 'TV_DRTV_LinearTV_10_Clicks', 'TV_DRTV_LinearTV_120_Clicks', 'TV_DRTV_LinearTV_15_Clicks', 'TV_DRTV_LinearTV_30_Clicks', 'TV_DRTV_LinearTV_60_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_TV_LTV.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_TV_LTV.csv').drop('Unnamed: 0',axis=1)
model_df.head()
