...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_TV_LTV.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
for col in model_df.columns:
  if col.startswith('TV_DRTV_LinearTV') &  col.endswith('_AdStock6L2Wk70Ad_Power70'):
    print(col)
...
model_cols = [
'TV_DRTV_LinearTV_10_Imps_AdStock6L2Wk70Ad_Power70',
'TV_DRTV_LinearTV_120_Imps_AdStock6L2Wk70Ad_Power70',
'TV_DRTV_LinearTV_15_Imps_AdStock6L2Wk70Ad_Power70',
'TV_DRTV_LinearTV_30_Imps_AdStock6L2Wk70Ad_Power70',
'TV_DRTV_LinearTV_60_Imps_AdStock6L2Wk70Ad_Power70'
]

data_cols = [
'TV_DRTV_LinearTV_10_Spend', 
'TV_DRTV_LinearTV_120_Spend', 
'TV_DRTV_LinearTV_15_Spend', 
'TV_DRTV_LinearTV_30_Spend', 
'TV_DRTV_LinearTV_60_Spend'
]
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       tv_DRTV_LinearTV_10_idx = pm.MutableData('tv_DRTV_LinearTV_10_idx', model_df['TV_DRTV_LinearTV_10_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       tv_DRTV_LinearTV_120_idx = pm.MutableData('tv_DRTV_LinearTV_120_idx', model_df['TV_DRTV_LinearTV_120_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       tv_DRTV_LinearTV_15_idx = pm.MutableData('tv_DRTV_LinearTV_15_idx', model_df['TV_DRTV_LinearTV_15_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       tv_DRTV_LinearTV_30_idx = pm.MutableData('tv_DRTV_LinearTV_30_idx', model_df['TV_DRTV_LinearTV_30_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       tv_DRTV_LinearTV_60_idx = pm.MutableData('tv_DRTV_LinearTV_60_idx', model_df['TV_DRTV_LinearTV_60_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       ...
       beta_DRTV_LinearTV_10_tv =    pm.Uniform('beta_DRTV_LinearTV_10_tv', lower= 0.03037*0.02 - 0.0002, upper = 0.03037*0.02 + 0.0002)
       beta_DRTV_LinearTV_15_tv =    pm.Uniform('beta_DRTV_LinearTV_15_tv', lower= 0.03037*0.04 - 0.0001, upper = 0.03037*0.04 + 0.0001)
       beta_DRTV_LinearTV_30_tv =    pm.Uniform('beta_DRTV_LinearTV_30_tv', lower= 0.03037*0.34 - 0.003, upper = 0.03037*0.34 + 0.003)
       beta_DRTV_LinearTV_60_tv =    pm.Uniform('beta_DRTV_LinearTV_60_tv', lower= 0.03037*0.34 - 0.003, upper = 0.03037*0.34 + 0.003)
       beta_DRTV_LinearTV_120_tv =    pm.Uniform('beta_DRTV_LinearTV_120_tv', lower= 0.03037*0.27/20 - 0.0001, upper = 0.03037*0.27/20 + 0.0001)



       # beta_MediaCom_BrandTV_tv =    pm.Normal('beta_MediaCom_BrandTV_tv', mu= 0.037/4,sigma=0.005)
       # beta_MediaCom_NonBrandTV_tv =    pm.Normal('beta_MediaCom_NonBrandTV_tv', mu= 0.037/4,sigma=0.005)
...
'beta_DRTV_LinearTV_10_tv': 'TV_DRTV_LinearTV_10_Imps_AdStock6L2Wk70Ad_Power70',
'beta_DRTV_LinearTV_15_tv': 'TV_DRTV_LinearTV_15_Imps_AdStock6L2Wk70Ad_Power70',
'beta_DRTV_LinearTV_30_tv': 'TV_DRTV_LinearTV_30_Imps_AdStock6L2Wk70Ad_Power70',
'beta_DRTV_LinearTV_60_tv': 'TV_DRTV_LinearTV_60_Imps_AdStock6L2Wk70Ad_Power70',
'beta_DRTV_LinearTV_120_tv': 'TV_DRTV_LinearTV_120_Imps_AdStock6L2Wk70Ad_Power70',
...
### Updating Spend Number ###
spend_22_dict = {'TV_DRTV_LinearTV_10_Imps': 0,'TV_DRTV_LinearTV_15_Imps': 28966.66,'TV_DRTV_LinearTV_30_Imps': 1426577.45,'TV_DRTV_LinearTV_60_Imps': 7759911.09,'TV_DRTV_LinearTV_120_Imps': 104461.80}
spend_23_dict = {'TV_DRTV_LinearTV_10_Imps': 32676.17,'TV_DRTV_LinearTV_15_Imps': 43567.19,'TV_DRTV_LinearTV_30_Imps': 7113316.41,'TV_DRTV_LinearTV_60_Imps': 5122763.85,'TV_DRTV_LinearTV_120_Imps': 175096.00}


for support, spend_22 in spend_22_dict.items():
  agg_analysis_df.loc[agg_analysis_df['Support']==support, 'Spend_2022'] = spend_22


for support, spend_23 in spend_23_dict.items():
  agg_analysis_df.loc[agg_analysis_df['Support']==support, 'Spend_2023'] = spend_23
