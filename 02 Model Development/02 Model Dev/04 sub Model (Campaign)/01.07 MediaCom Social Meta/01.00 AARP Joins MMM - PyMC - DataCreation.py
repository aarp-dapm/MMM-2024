...
## Reaqding Data ##
rawdata_df=spark.sql('select * from temp.ja_blend_mmm2_MediaDf_Campaign_MediaCom_SocialMeta').toPandas()
rawdata_df.display()

# COMMAND ----------

for col in rawdata_df.columns:
  if col.startswith('Social_MediaCom_Meta_'):
    print(col)
...
rawdata_df['Social_MediaCom_Meta_NonBrand_Spend'] = rawdata_df[['Social_MediaCom_Meta_ODEI_Spend', 'Social_MediaCom_Meta_States_Spend', 'Social_MediaCom_Meta_TargetedCommunities_Spend']].sum(axis=1)
rawdata_df['Social_MediaCom_Meta_NonBrand_Imps'] = rawdata_df[['Social_MediaCom_Meta_ODEI_Imps', 'Social_MediaCom_Meta_States_Imps', 'Social_MediaCom_Meta_TargetedCommunities_Imps']].sum(axis=1)
rawdata_df['Social_MediaCom_Meta_NonBrand_Clicks'] = rawdata_df[['Social_MediaCom_Meta_ODEI_Clicks', 'Social_MediaCom_Meta_States_Clicks', 'Social_MediaCom_Meta_TargetedCommunities_Clicks']].sum(axis=1)
...
######### User Input Dict #############
#######################################
cols = ['Social_MediaCom_Meta_Brand_Imps', 'Social_MediaCom_Meta_NonBrand_Imps']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','Social_MediaCom_Meta_Brand_Imps', 'Social_MediaCom_Meta_NonBrand_Imps']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_MediaCom_SocialMeta.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_MediaCom_SocialMeta.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Social_MediaCom_Meta_Brand_Spend', 'Social_MediaCom_Meta_NonBrand_Spend', 'Social_MediaCom_Meta_Brand_Imps', 'Social_MediaCom_Meta_NonBrand_Imps', 'Social_MediaCom_Meta_Brand_Clicks', 'Social_MediaCom_Meta_NonBrand_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_SocialMeta.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_SocialMeta.csv').drop('Unnamed: 0',axis=1)
model_df.head()
