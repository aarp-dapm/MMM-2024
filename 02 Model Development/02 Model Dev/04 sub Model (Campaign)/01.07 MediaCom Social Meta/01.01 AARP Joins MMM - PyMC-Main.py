...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_MediaCom_SocialMeta.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
for col in model_df.columns:
  if col.startswith('Social_MediaCom_Meta') and col.split("_")[-1] in ['Spend', 'Imps', 'Clicks']:
    print(col)
...
model_cols = ['Social_MediaCom_Meta_Brand_Imps_AdStock6L1Wk90Ad_Power90', 'Social_MediaCom_Meta_NonBrand_Imps_AdStock6L1Wk90Ad_Power90']

data_cols = [ 'Social_MediaCom_Meta_Brand_Spend', 'Social_MediaCom_Meta_NonBrand_Spend' ]
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       # social_MediaCom_Meta_idx = pm.MutableData('social_MediaCom_Meta_idx', model_df['Social_MediaCom_Meta_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_MediaCom_Meta_Brand_idx = pm.MutableData('social_MediaCom_Meta_Brand_idx', model_df['Social_MediaCom_Meta_Brand_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_MediaCom_Meta_NonBrand_idx = pm.MutableData('social_MediaCom_Meta_NonBrand_idx', model_df['Social_MediaCom_Meta_NonBrand_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')



       social_MediaCom_TikTok_idx = pm.MutableData('social_MediaCom_TikTok_idx', model_df['Social_MediaCom_TikTok_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_MediaCom_X_idx = pm.MutableData('social_MediaCom_X_idx', model_df['Social_MediaCom_X_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       ...
       # beta_MediaCom_Meta_social =  pm.Uniform('beta_MediaCom_Meta_social', lower= 0.029*0.08*0.91 - 0.002,upper=0.029*0.08*0.91 + 0.002)
       beta_MediaCom_Meta_Brand_social =  pm.Uniform('beta_MediaCom_Meta_Brand_social', lower= 0.029*0.08*0.91*0.83 - 0.001,upper=0.029*0.08*0.91*0.83 + 0.001)
       beta_MediaCom_Meta_NonBrand_social =  pm.Uniform('beta_MediaCom_Meta_NonBrand_social', lower= 0.029*0.08*0.91*0.17 - 0.0002,upper=0.029*0.08*0.91*0.17 + 0.0002)



       beta_MediaCom_TikTok_social =  pm.Uniform('beta_MediaCom_TikTok_social', lower= 0.029*0.08*0.09 - 0.002,upper=0.029*0.08*0.09 + 0.002)
       beta_MediaCom_X_social =  pm.Uniform('beta_MediaCom_X_social', lower= 0.029*0.08 - 0.002,upper=0.029*0.08 + 0.002)
       ...
       y_hat = intercept_re[dma_idx] + beta_PromoEvnt_22MembDrive*PromoEvnt_22MembDrive_idx + beta_PromoEvnt_22BlackFriday*PromoEvnt_22BlackFriday_idx + beta_PromoEvnt_23MembDrive*PromoEvnt_23MembDrive_idx + beta_PromoEvnt_23BlackFriday*PromoEvnt_23BlackFriday_idx + beta_Seasonality_Mar*Seasonality_Mar_idx + beta_Seasonality_Apr*Seasonality_Apr_idx + beta_Seasonality_Feb*Seasonality_Feb_idx + beta_Seasonality_Dec*Seasonality_Dec_idx + beta_July0422_lag*July0422_lag_idx + beta_leadgen*leadgen_idx + beta_tv*tv_idx + beta_AltMedia*AltMedia_idx + beta_dm *dm_idx + beta_email*email_idx + beta_search*search_idx + beta_ASI_social*social_ASI_idx + beta_IcmDigital_social*social_IcmDigital_idx + beta_IcmSocial_social*social_IcmSocial_idx + beta_MembershipDigital_social*social_MembershipDigital_idx + beta_MediaCom_TikTok_social*social_MediaCom_TikTok_idx + beta_MediaCom_X_social*social_MediaCom_X_idx + beta_MediaCom_Meta_Brand_social*social_MediaCom_Meta_Brand_idx + beta_MediaCom_Meta_NonBrand_social*social_MediaCom_Meta_NonBrand_idx 
...
'beta_MediaCom_Meta_Brand_social':'Social_MediaCom_Meta_Brand_Imps_AdStock6L1Wk90Ad_Power90',
'beta_MediaCom_Meta_NonBrand_social':'Social_MediaCom_Meta_NonBrand_Imps_AdStock6L1Wk90Ad_Power90',
...
'Social_MediaCom_Meta_Brand_Imps_AdStock6L1Wk90Ad_Power90',
'Social_MediaCom_Meta_NonBrand_Imps_AdStock6L1Wk90Ad_Power90',
