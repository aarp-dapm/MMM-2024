...
## Reaqding Data ##
rawdata_df=spark.sql('select * from temp.ja_blend_mmm2_MediaDf_Campaign_TV_CTV').toPandas()
rawdata_df.display()
...
######### User Input Dict #############
#######################################
cols = ['TV_DRTV_ConnectedTV_PublisherDirect_Imps', 'TV_DRTV_ConnectedTV_Roku_Imps', 'TV_DRTV_ConnectedTV_Samsung_Imps', 'TV_DRTV_ConnectedTV_Yahoo_Imps']

input_dict = {}
for col in cols:
  input_dict[col] = {'Adstock':{'week_cutoff':[6,13], 'peak_week':[1,2,3,4,5], 'decay_rate': list(frange(0.1,0.9,0.1))}, 'Saturation':{'power':list(frange(0.1,0.9,0.1))}}
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','TV_DRTV_ConnectedTV_PublisherDirect_Imps', 'TV_DRTV_ConnectedTV_Roku_Imps', 'TV_DRTV_ConnectedTV_Samsung_Imps', 'TV_DRTV_ConnectedTV_Yahoo_Imps']]
# MAGIC
...
## Saving Model ##
# transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_TV_CTV.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_Campaign_TV_CTV.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'TV_DRTV_ConnectedTV_PublisherDirect_Spend', 'TV_DRTV_ConnectedTV_Roku_Spend', 'TV_DRTV_ConnectedTV_Samsung_Spend', 'TV_DRTV_ConnectedTV_Yahoo_Spend', 'TV_DRTV_ConnectedTV_PublisherDirect_Imps', 'TV_DRTV_ConnectedTV_Roku_Imps', 'TV_DRTV_ConnectedTV_Samsung_Imps', 'TV_DRTV_ConnectedTV_Yahoo_Imps', 
'TV_DRTV_ConnectedTV_PublisherDirect_Clicks', 'TV_DRTV_ConnectedTV_Roku_Clicks', 'TV_DRTV_ConnectedTV_Samsung_Clicks', 'TV_DRTV_ConnectedTV_Yahoo_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_TV_CTV.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_TV_CTV.csv').drop('Unnamed: 0',axis=1)
model_df.head()
