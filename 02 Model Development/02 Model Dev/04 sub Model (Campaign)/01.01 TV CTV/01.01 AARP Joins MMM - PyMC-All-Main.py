...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_Campaign_TV_CTV.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
for col in model_df.columns:
  if col.startswith('TV_DRTV_ConnectedTV') &  col.endswith('_AdStock6L2Wk70Ad_Power70'):
    print(col)
...
model_cols = [
'TV_DRTV_ConnectedTV_PublisherDirect_Imps_AdStock6L2Wk70Ad_Power70',
'TV_DRTV_ConnectedTV_Roku_Imps_AdStock6L2Wk70Ad_Power70',
'TV_DRTV_ConnectedTV_Samsung_Imps_AdStock6L2Wk70Ad_Power70',
'TV_DRTV_ConnectedTV_Yahoo_Imps_AdStock6L2Wk70Ad_Power70'
]

data_cols = [
'TV_DRTV_ConnectedTV_PublisherDirect_Spend',
'TV_DRTV_ConnectedTV_Roku_Spend',
'TV_DRTV_ConnectedTV_Samsung_Spend',
'TV_DRTV_ConnectedTV_Yahoo_Spend'
]
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       tv_DRTV_ConnectedTV_PublisherDirect_idx = pm.MutableData('tv_DRTV_ConnectedTV_PublisherDirect_idx', model_df['TV_DRTV_ConnectedTV_PublisherDirect_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       tv_DRTV_ConnectedTV_Roku_idx = pm.MutableData('tv_DRTV_ConnectedTV_Roku_idx', model_df['TV_DRTV_ConnectedTV_Roku_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       tv_DRTV_ConnectedTV_Samsung_idx = pm.MutableData('tv_DRTV_ConnectedTV_Samsung_idx', model_df['TV_DRTV_ConnectedTV_Samsung_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       tv_DRTV_ConnectedTV_Yahoo_idx = pm.MutableData('tv_DRTV_ConnectedTV_Yahoo_idx', model_df['TV_DRTV_ConnectedTV_Yahoo_Imps_AdStock6L2Wk70Ad_Power70'].values, dims='obs_id')
       ...
       beta_DRTV_ConnectedTV_PublisherDirect_tv =    pm.Uniform('beta_DRTV_ConnectedTV_PublisherDirect_tv', lower = 0.00684*0.07 - 0.0002,upper=0.00684*0.07 + 0.0002) #pm.Normal('beta_DRTV_ConnectedTV_PublisherDirect_tv', mu= 0.00684/4,sigma=0.005)
       beta_DRTV_ConnectedTV_Roku_tv =    pm.Uniform('beta_DRTV_ConnectedTV_Roku_tv',  lower = 0.00684*0.58 - 0.0002,upper=0.00684*0.58 + 0.0002)
       beta_DRTV_ConnectedTV_Samsung_tv =    pm.Uniform('beta_DRTV_ConnectedTV_Samsung_tv',  lower = 0.00684*0.31 - 0.0002,upper=0.00684*0.31 + 0.0002)
       beta_DRTV_ConnectedTV_Yahoo_tv =    pm.Uniform('beta_DRTV_ConnectedTV_Yahoo_tv',  lower = 0.00684*0.04 - 0.0002,upper=0.00684*0.04 + 0.0002)
...
'beta_DRTV_ConnectedTV_PublisherDirect_tv': 'TV_DRTV_ConnectedTV_PublisherDirect_Imps_AdStock6L2Wk70Ad_Power70',
'beta_DRTV_ConnectedTV_Roku_tv': 'TV_DRTV_ConnectedTV_Roku_Imps_AdStock6L2Wk70Ad_Power70',
'beta_DRTV_ConnectedTV_Samsung_tv': 'TV_DRTV_ConnectedTV_Samsung_Imps_AdStock6L2Wk70Ad_Power70',
'beta_DRTV_ConnectedTV_Yahoo_tv': 'TV_DRTV_ConnectedTV_Yahoo_Imps_AdStock6L2Wk70Ad_Power70',
