...
cols = ['AltMedia_AltMedia_BILLINGSTATEMENT_Spend',
...
rawdata_df.groupby('Date')[cols].sum().reset_index().display()
...
for col in rawdata_df.columns:
  if (col.split('_')[0] == 'AltMedia') & (col.split('_')[-1] == 'Imps'):
    cols.append(col)
cols
...
######### User Input Dict #############
#######################################
cols = ['AltMedia_AltMedia_BILLINGSTATEMENT_Imps', 'AltMedia_AltMedia_BlowIn_Imps', 'AltMedia_AltMedia_CoOp_Imps', 'AltMedia_AltMedia_MAGAZINE_Imps', 'AltMedia_AltMedia_NEWSPAPER_Imps', 'AltMedia_AltMedia_PIP_Imps', 'AltMedia_AltMedia_PROSPECTRAL_Imps', 'AltMedia_AltMedia_SHAREDMAILWRAP_Imps', 'AltMedia_AltMedia_SHAREDMAIL_Imps']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','AltMedia_AltMedia_BILLINGSTATEMENT_Imps', 'AltMedia_AltMedia_BlowIn_Imps', 'AltMedia_AltMedia_CoOp_Imps', 'AltMedia_AltMedia_MAGAZINE_Imps', 'AltMedia_AltMedia_NEWSPAPER_Imps', 'AltMedia_AltMedia_PIP_Imps', 'AltMedia_AltMedia_PROSPECTRAL_Imps', 'AltMedia_AltMedia_SHAREDMAILWRAP_Imps', 'AltMedia_AltMedia_SHAREDMAIL_Imps']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_AltMedia.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_AltMedia.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'AltMedia_AltMedia_BILLINGSTATEMENT_Spend', 'AltMedia_AltMedia_BlowIn_Spend', 'AltMedia_AltMedia_CoOp_Spend', 'AltMedia_AltMedia_MAGAZINE_Spend', 'AltMedia_AltMedia_NEWSPAPER_Spend', 'AltMedia_AltMedia_PIP_Spend', 'AltMedia_AltMedia_PROSPECTRAL_Spend', 'AltMedia_AltMedia_SHAREDMAILWRAP_Spend', 'AltMedia_AltMedia_SHAREDMAIL_Spend', 'AltMedia_AltMedia_BILLINGSTATEMENT_Imps', 'AltMedia_AltMedia_BlowIn_Imps', 'AltMedia_AltMedia_CoOp_Imps', 'AltMedia_AltMedia_MAGAZINE_Imps', 'AltMedia_AltMedia_NEWSPAPER_Imps', 'AltMedia_AltMedia_PIP_Imps', 'AltMedia_AltMedia_PROSPECTRAL_Imps', 'AltMedia_AltMedia_SHAREDMAILWRAP_Imps', 'AltMedia_AltMedia_SHAREDMAIL_Imps', 'AltMedia_AltMedia_BILLINGSTATEMENT_Clicks', 'AltMedia_AltMedia_BlowIn_Clicks', 'AltMedia_AltMedia_CoOp_Clicks', 'AltMedia_AltMedia_MAGAZINE_Clicks', 'AltMedia_AltMedia_NEWSPAPER_Clicks', 'AltMedia_AltMedia_PIP_Clicks', 'AltMedia_AltMedia_PROSPECTRAL_Clicks', 'AltMedia_AltMedia_SHAREDMAILWRAP_Clicks', 'AltMedia_AltMedia_SHAREDMAIL_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_AltMedia.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_AltMedia.csv').drop('Unnamed: 0',axis=1)
model_df.head()
