...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_AltMedia.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
model_df['AltMedia_AltMedia_News&Mag_Spend'] = model_df['AltMedia_AltMedia_MAGAZINE_Spend'] + model_df['AltMedia_AltMedia_NEWSPAPER_Spend']
model_df['AltMedia_AltMedia_SharedMailnWrap_Spend'] = model_df['AltMedia_AltMedia_SHAREDMAIL_Spend'] + model_df['AltMedia_AltMedia_SHAREDMAILWRAP_Spend']
model_df['AltMedia_AltMedia_Other_Spend'] = model_df['AltMedia_AltMedia_BILLINGSTATEMENT_Spend'] + model_df['AltMedia_AltMedia_BlowIn_Spend'] + model_df['AltMedia_AltMedia_CoOp_Spend'] + model_df['AltMedia_AltMedia_PIP_Spend'] + model_df['AltMedia_AltMedia_PROSPECTRAL_Spend']

# COMMAND ----------

## CLubbing Adding Columns ##

## Newspaper and Magazine ##
model_df['AltMedia_AltMedia_News&Mag_Spend'] = model_df['AltMedia_AltMedia_MAGAZINE_Spend'] + model_df['AltMedia_AltMedia_NEWSPAPER_Spend']
model_df['AltMedia_AltMedia_News&Mag_Imps'] = model_df['AltMedia_AltMedia_MAGAZINE_Imps'] + model_df['AltMedia_AltMedia_NEWSPAPER_Imps']
model_df['AltMedia_AltMedia_News&Mag_Imps_AdStock6L3Wk90Ad_Power90'] = model_df['AltMedia_AltMedia_MAGAZINE_Imps_AdStock6L3Wk90Ad_Power90'] + model_df['AltMedia_AltMedia_NEWSPAPER_Imps_AdStock6L3Wk90Ad_Power90']

## SharedMail and SharedMail Wrap ##
model_df['AltMedia_AltMedia_SharedMailnWrap_Spend'] = model_df['AltMedia_AltMedia_SHAREDMAIL_Spend'] + model_df['AltMedia_AltMedia_SHAREDMAILWRAP_Spend']
model_df['AltMedia_AltMedia_SharedMailnWrap_Imps'] = model_df['AltMedia_AltMedia_SHAREDMAIL_Imps'] + model_df['AltMedia_AltMedia_SHAREDMAILWRAP_Imps']
model_df['AltMedia_AltMedia_SharedMailnWrap_Imps_AdStock6L3Wk90Ad_Power90'] = model_df['AltMedia_AltMedia_SHAREDMAIL_Imps_AdStock6L3Wk90Ad_Power90'] + model_df['AltMedia_AltMedia_SHAREDMAILWRAP_Imps_AdStock6L3Wk90Ad_Power90']


## Billing Statement, PIP, Prospectral, BlowIn, CoOp ##
model_df['AltMedia_AltMedia_Other_Spend'] = model_df['AltMedia_AltMedia_BILLINGSTATEMENT_Spend'] + model_df['AltMedia_AltMedia_BlowIn_Spend'] + model_df['AltMedia_AltMedia_CoOp_Spend'] + model_df['AltMedia_AltMedia_PIP_Spend'] + model_df['AltMedia_AltMedia_PROSPECTRAL_Spend']
model_df['AltMedia_AltMedia_Other_Imps'] = model_df['AltMedia_AltMedia_BILLINGSTATEMENT_Imps'] + model_df['AltMedia_AltMedia_BlowIn_Imps'] + model_df['AltMedia_AltMedia_CoOp_Imps'] + model_df['AltMedia_AltMedia_PIP_Imps'] + model_df['AltMedia_AltMedia_PROSPECTRAL_Imps']
model_df['AltMedia_AltMedia_Other_Imps_AdStock6L3Wk90Ad_Power90'] = model_df['AltMedia_AltMedia_BILLINGSTATEMENT_Imps_AdStock6L3Wk90Ad_Power90'] + model_df['AltMedia_AltMedia_BlowIn_Imps_AdStock6L3Wk90Ad_Power90'] + model_df['AltMedia_AltMedia_CoOp_Imps_AdStock6L3Wk90Ad_Power90'] + model_df['AltMedia_AltMedia_PIP_Imps_AdStock6L3Wk90Ad_Power90'] + model_df['AltMedia_AltMedia_PROSPECTRAL_Imps_AdStock6L3Wk90Ad_Power90']
...
model_cols = [
# 'AltMedia_AltMedia_BILLINGSTATEMENT_Imps_AdStock6L3Wk90Ad_Power90', 
# 'AltMedia_AltMedia_BlowIn_Imps_AdStock6L3Wk90Ad_Power90', 
# 'AltMedia_AltMedia_CoOp_Imps_AdStock6L3Wk90Ad_Power90', 
# 'AltMedia_AltMedia_PIP_Imps_AdStock6L3Wk90Ad_Power90', 
# 'AltMedia_AltMedia_PROSPECTRAL_Imps_AdStock6L3Wk90Ad_Power90', 
'AltMedia_AltMedia_Other_Imps_AdStock6L3Wk90Ad_Power90',

# 'AltMedia_AltMedia_MAGAZINE_Imps_AdStock6L3Wk90Ad_Power90', 
# 'AltMedia_AltMedia_NEWSPAPER_Imps_AdStock6L3Wk90Ad_Power90', 
'AltMedia_AltMedia_News&Mag_Imps_AdStock6L3Wk90Ad_Power90',



# 'AltMedia_AltMedia_SHAREDMAILWRAP_Imps_AdStock6L3Wk90Ad_Power90', 
# 'AltMedia_AltMedia_SHAREDMAIL_Imps_AdStock6L3Wk90Ad_Power90'
'AltMedia_AltMedia_SharedMailnWrap_Imps_AdStock6L3Wk90Ad_Power90'

]

data_cols = [
# 'AltMedia_AltMedia_BILLINGSTATEMENT_Spend', 
# 'AltMedia_AltMedia_BlowIn_Spend', 
# 'AltMedia_AltMedia_CoOp_Spend', 
# 'AltMedia_AltMedia_PIP_Spend', 
# 'AltMedia_AltMedia_PROSPECTRAL_Spend', 
'AltMedia_AltMedia_Other_Spend', 

# 'AltMedia_AltMedia_MAGAZINE_Spend', 
# 'AltMedia_AltMedia_NEWSPAPER_Spend', 
'AltMedia_AltMedia_News&Mag_Spend',

# 'AltMedia_AltMedia_SHAREDMAILWRAP_Spend', 
# 'AltMedia_AltMedia_SHAREDMAIL_Spend'
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       # AltMedia_BILLINGSTATEMENT_idx = pm.MutableData('AltMedia_BILLINGSTATEMENT_idx', model_df['AltMedia_AltMedia_BILLINGSTATEMENT_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       # AltMedia_BlowIn_idx = pm.MutableData('AltMedia_BlowIn_idx', model_df['AltMedia_AltMedia_BlowIn_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       # AltMedia_CoOp_idx = pm.MutableData('AltMedia_CoOp_idx', model_df['AltMedia_AltMedia_CoOp_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       # AltMedia_PIP_idx = pm.MutableData('AltMedia_PIP_idx', model_df['AltMedia_AltMedia_PIP_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       # AltMedia_PROSPECTRAL_idx = pm.MutableData('AltMedia_PROSPECTRAL_idx', model_df['AltMedia_AltMedia_PROSPECTRAL_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       AltMedia_Other_idx = pm.MutableData('AltMedia_Other_idx', model_df['AltMedia_AltMedia_Other_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       
       # AltMedia_MAGAZINE_idx = pm.MutableData('AltMedia_MAGAZINE_idx', model_df['AltMedia_AltMedia_MAGAZINE_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       # AltMedia_NEWSPAPER_idx = pm.MutableData('AltMedia_NEWSPAPER_idx', model_df['AltMedia_AltMedia_NEWSPAPER_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       AltMedia_NewsnMag_idx = pm.MutableData('AltMedia_News&Mag_idx', model_df['AltMedia_AltMedia_News&Mag_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       
       

       # AltMedia_SHAREDMAILWRAP_idx = pm.MutableData('AltMedia_SHAREDMAILWRAP_idx', model_df['AltMedia_AltMedia_SHAREDMAILWRAP_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       # AltMedia_SHAREDMAIL_idx = pm.MutableData('AltMedia_SHAREDMAIL_idx', model_df['AltMedia_AltMedia_SHAREDMAIL_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       AltMedia_SharedMailnWrap_idx = pm.MutableData('AltMedia_SharedMailnWrap_idx', model_df['AltMedia_AltMedia_SharedMailnWrap_Imps_AdStock6L3Wk90Ad_Power90'].values, dims='obs_id')
       ...
       # beta_BILLINGSTATEMENT_AltMedia = pm.Uniform('beta_BILLINGSTATEMENT_AltMedia', lower= 0.084*0.02,upper=0.084*0.02 + 0.0004) #pm.Normal('beta_BILLINGSTATEMENT_AltMedia', mu= 0.084/9,sigma=0.004)  
       # beta_BlowIn_AltMedia = pm.Normal('beta_BlowIn_AltMedia', mu= 0.084/9,sigma=0.004) 
       # beta_CoOp_AltMedia = pm.Uniform('beta_CoOp_AltMedia', lower= 0.084*0.02,upper=0.084*0.02 + 0.0004)  #pm.Normal('beta_CoOp_AltMedia', mu= 0.084/9,sigma=0.004) 
       # beta_PIP_AltMedia = pm.Uniform('beta_PIP_AltMedia', lower= 0.084*0.01,upper=0.084*0.01 + 0.0004) #pm.Normal('beta_PIP_AltMedia', mu= 0.084/9,sigma=0.004) 
       # beta_PROSPECTRAL_AltMedia = pm.Uniform('beta_PROSPECTRAL_AltMedia', lower= 0.084*0.01,upper=0.084*0.01 + 0.0004)  #pm.Normal('beta_PROSPECTRAL_AltMedia', mu= 0.084/9,sigma=0.004) 
       beta_Other_AltMedia = pm.Uniform('beta_Other_AltMedia', lower= 0.084*0.01,upper=0.084*0.01 + 0.0004)  #pm.Normal('beta_PROSPECTRAL_AltMedia', mu= 0.084/9,sigma=0.004)


       # beta_MAGAZINE_AltMedia = pm.Uniform('beta_MAGAZINE_AltMedia', lower= 0.084*0.06,upper=0.084*0.06 + 0.004)  #pm.Normal('beta_MAGAZINE_AltMedia', mu= 0.084/9,sigma=0.004) 
       # beta_NEWSPAPER_AltMedia = pm.Normal('beta_NEWSPAPER_AltMedia', mu= 0.084/9,sigma=0.004) 
       beta_NewsnMag_AltMedia = pm.Normal('beta_NewsnMag_AltMedia', mu= 0.084/9,sigma=0.004) 
       
       # beta_SHAREDMAILWRAP_AltMedia = pm.Normal('beta_SHAREDMAILWRAP_AltMedia', mu= 0.084/9,sigma=0.004) 
       # beta_SHAREDMAIL_AltMedia = pm.Normal('beta_SHAREDMAIL_AltMedia', mu= 0.084/9,sigma=0.004) 
       beta_SharedMailnWrap_AltMedia = pm.Normal('beta_SharedMailnWrap_AltMedia', mu= 0.084/9,sigma=0.004) 
       ...
       y_hat = intercept_re[dma_idx] + beta_search*search_idx + beta_social*social_idx + beta_email*email_idx + beta_dm*dm_idx + beta_PromoEvnt_22MembDrive*PromoEvnt_22MembDrive_idx + beta_PromoEvnt_22BlackFriday*PromoEvnt_22BlackFriday_idx + beta_PromoEvnt_23MembDrive*PromoEvnt_23MembDrive_idx + beta_PromoEvnt_23BlackFriday*PromoEvnt_23BlackFriday_idx + beta_Seasonality_Mar*Seasonality_Mar_idx + beta_Seasonality_Apr*Seasonality_Apr_idx + beta_Seasonality_Feb*Seasonality_Feb_idx + beta_Seasonality_Dec*Seasonality_Dec_idx + beta_July0422_lag*July0422_lag_idx + beta_leadgen*leadgen_idx + beta_tv*tv_idx + beta_NewsnMag_AltMedia*AltMedia_NewsnMag_idx + beta_Other_AltMedia*AltMedia_Other_idx + beta_SharedMailnWrap_AltMedia*AltMedia_SharedMailnWrap_idx
...
# 'beta_BILLINGSTATEMENT_AltMedia':'AltMedia_AltMedia_BILLINGSTATEMENT_Imps_AdStock6L3Wk90Ad_Power90',
# 'beta_BlowIn_AltMedia':'AltMedia_AltMedia_BlowIn_Imps_AdStock6L3Wk90Ad_Power90',
# 'beta_CoOp_AltMedia':'AltMedia_AltMedia_CoOp_Imps_AdStock6L3Wk90Ad_Power90',
# 'beta_PIP_AltMedia':'AltMedia_AltMedia_PIP_Imps_AdStock6L3Wk90Ad_Power90',
# 'beta_PROSPECTRAL_AltMedia':'AltMedia_AltMedia_PROSPECTRAL_Imps_AdStock6L3Wk90Ad_Power90',
'beta_Other_AltMedia':'AltMedia_AltMedia_Other_Imps_AdStock6L3Wk90Ad_Power90',

# 'beta_MAGAZINE_AltMedia':'AltMedia_AltMedia_MAGAZINE_Imps_AdStock6L3Wk90Ad_Power90',
# 'beta_NEWSPAPER_AltMedia':'AltMedia_AltMedia_NEWSPAPER_Imps_AdStock6L3Wk90Ad_Power90',
'beta_NewsnMag_AltMedia':'AltMedia_AltMedia_News&Mag_Imps_AdStock6L3Wk90Ad_Power90',

# 'beta_SHAREDMAILWRAP_AltMedia':'AltMedia_AltMedia_SHAREDMAILWRAP_Imps_AdStock6L3Wk90Ad_Power90',
# 'beta_SHAREDMAIL_AltMedia':'AltMedia_AltMedia_SHAREDMAIL_Imps_AdStock6L3Wk90Ad_Power90',
'beta_SharedMailnWrap_AltMedia':'AltMedia_AltMedia_SharedMailnWrap_Imps_AdStock6L3Wk90Ad_Power90',
