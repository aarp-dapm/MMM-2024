...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_DirectMail.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
## Clubbing Data ##
model_df['DirectMail_AcqMail_DirectnConnectedTV_Spend'] = model_df['DirectMail_AcqMail_ConnectedTV_Spend'] + model_df['DirectMail_AcqMail_DirectMail_Spend']
model_df['DirectMail_AcqMail_DirectnConnectedTV_Imps'] = model_df['DirectMail_AcqMail_ConnectedTV_Imps'] + model_df['DirectMail_AcqMail_DirectMail_Imps']
model_df['DirectMail_AcqMail_DirectnConnectedTV_Imps_AdStock6L3Wk70Ad_Power90'] = model_df['DirectMail_AcqMail_ConnectedTV_Imps_AdStock6L3Wk70Ad_Power90'] + model_df['DirectMail_AcqMail_DirectMail_Imps_AdStock6L3Wk70Ad_Power90']
...
model_cols = [
  ...
  'DirectMail_AcqMail_ConnectedTV_Imps_AdStock6L3Wk70Ad_Power90',
  'DirectMail_AcqMail_DirectMail_Imps_AdStock6L3Wk70Ad_Power90', 
  # 'DirectMail_AcqMail_DirectnConnectedTV_Imps_AdStock6L3Wk70Ad_Power90',
  
  'DirectMail_AcqMail_WinbackMail_Imps_AdStock6L3Wk70Ad_Power90'
...
data_cols = [
  ...
  # 'DirectMail_AcqMail_DirectnConnectedTV_Spend', 
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       # dm_ConnectedTV_idx = pm.MutableData('dm_ConnectedTV_idx', model_df['DirectMail_AcqMail_ConnectedTV_Imps_AdStock6L3Wk70Ad_Power90'].values, dims='obs_id')
       dm_DirectMail_idx = pm.MutableData('dm_DirectMail_idx', model_df['DirectMail_AcqMail_DirectMail_Imps_AdStock6L3Wk70Ad_Power90'].values, dims='obs_id')
       # dm_DirectnConnectedTV_idx = pm.MutableData('dm_DirectnConnectedTV_idx', model_df['DirectMail_AcqMail_DirectnConnectedTV_Imps_AdStock6L3Wk70Ad_Power90'].values, dims='obs_id')

       dm_WinbackMail_idx = pm.MutableData('dm_WinbackMail_idx', model_df['DirectMail_AcqMail_WinbackMail_Imps_AdStock6L3Wk70Ad_Power90'].values, dims='obs_id')
       ...
       # beta_ConnectedTV_dm =   pm.Uniform('beta_ConnectedTV_dm', lower= 0.04655/100 - 0.0001,upper=0.04655/100 + 0.0001) #pm.Normal('beta_ConnectedTV_dm', mu= 0.082,sigma=0.005)  
       beta_DirectMail_dm =   pm.Normal('beta_DirectMail_dm', mu= 0.082,sigma=0.005)
       # beta_DirectnConnectedTV_dm =   pm.Normal('beta_DirectnConnectedTV_dm', mu= 0.082,sigma=0.005)

       beta_WinbackMail_dm =   pm.Normal('beta_WinbackMail_dm', mu= 0.082,sigma=0.005)    
       ...
       y_hat = intercept_re[dma_idx] + beta_search*search_idx + beta_social*social_idx + beta_email*email_idx + beta_PromoEvnt_22MembDrive*PromoEvnt_22MembDrive_idx + beta_PromoEvnt_22BlackFriday*PromoEvnt_22BlackFriday_idx + beta_PromoEvnt_23MembDrive*PromoEvnt_23MembDrive_idx + beta_PromoEvnt_23BlackFriday*PromoEvnt_23BlackFriday_idx + beta_Seasonality_Mar*Seasonality_Mar_idx + beta_Seasonality_Apr*Seasonality_Apr_idx + beta_Seasonality_Feb*Seasonality_Feb_idx + beta_Seasonality_Dec*Seasonality_Dec_idx + beta_July0422_lag*July0422_lag_idx + beta_leadgen*leadgen_idx + beta_tv*tv_idx + beta_AltMedia*AltMedia_idx  + beta_WinbackMail_dm *dm_WinbackMail_idx + beta_DirectMail_dm *dm_DirectMail_idx
...
# Model Summary #
summary_df = az.summary(varying_intercept_trace, round_to=9).reset_index()
summary_df.display()
...
# 'beta_ConnectedTV_dm': 'DirectMail_AcqMail_ConnectedTV_Imps_AdStock6L3Wk70Ad_Power90',
'beta_DirectMail_dm': 'DirectMail_AcqMail_DirectMail_Imps_AdStock6L3Wk70Ad_Power90',
# 'beta_DirectnConnectedTV_dm': 'DirectMail_AcqMail_DirectnConnectedTV_Imps_AdStock6L3Wk70Ad_Power90',

'beta_WinbackMail_dm': 'DirectMail_AcqMail_WinbackMail_Imps_AdStock6L3Wk70Ad_Power90',
