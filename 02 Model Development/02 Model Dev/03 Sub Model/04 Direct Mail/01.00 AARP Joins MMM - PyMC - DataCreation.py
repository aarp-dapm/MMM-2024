...
for col in rawdata_df.columns:
  if (col.split('_')[0] == 'DirectMail') & (col.split('_')[-1] == 'Imps'):
    cols.append(col)
cols
...
######### User Input Dict #############
#######################################
cols = ['DirectMail_AcqMail_ConnectedTV_Imps', 'DirectMail_AcqMail_DirectMail_Imps', 'DirectMail_AcqMail_WinbackMail_Imps']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date', 'DirectMail_AcqMail_ConnectedTV_Imps', 'DirectMail_AcqMail_DirectMail_Imps', 'DirectMail_AcqMail_WinbackMail_Imps']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_DirectMail.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_DirectMail.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'DirectMail_AcqMail_ConnectedTV_Spend', 'DirectMail_AcqMail_DirectMail_Spend', 'DirectMail_AcqMail_WinbackMail_Spend', 'DirectMail_AcqMail_ConnectedTV_Imps', 'DirectMail_AcqMail_DirectMail_Imps', 'DirectMail_AcqMail_WinbackMail_Imps', 'DirectMail_AcqMail_ConnectedTV_Clicks', 'DirectMail_AcqMail_DirectMail_Clicks', 'DirectMail_AcqMail_WinbackMail_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_DirectMail.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_DirectMail.csv').drop('Unnamed: 0',axis=1)
model_df.head()
