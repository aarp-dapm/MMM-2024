...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Display.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
'Display_ASI_Display_Spend', 
'Display_IcmDigital_Display_Spend', 
'Display_IcmDigital_Other_Spend', 
