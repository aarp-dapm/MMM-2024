...
for col in rawdata_df.columns:
  if (col.split('_')[0] == 'Display') & (col.split('_')[-1] == 'Clicks'):
    cols.append(col)
cols
...
######### User Input Dict #############
#######################################
cols = ['Display_ASI_Display_Imps', 'Display_IcmDigital_Display_Imps', 'Display_IcmDigital_Other_Imps', 'Display_MediaCom_Display_Imps', 'Display_MembershipDigital_AmazonDSP_Imps', 'Display_MembershipDigital_DV360_Imps',
 'Display_MembershipDigital_Outbrain_Imps', 'Display_MembershipDigital_Yahoo_Imps']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date', 'Display_ASI_Display_Imps', 'Display_IcmDigital_Display_Imps', 'Display_IcmDigital_Other_Imps', 'Display_MediaCom_Display_Imps', 'Display_MembershipDigital_AmazonDSP_Imps', 'Display_MembershipDigital_DV360_Imps', 'Display_MembershipDigital_Outbrain_Imps', 'Display_MembershipDigital_Yahoo_Imps']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Display.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Display.csv').drop('Unnamed: 0',axis=1)
...
main_model_cols_spend = ['TV_Spend', 'Search_Spend', 'Social_Spend', 'LeadGen_Spend', 'Email_Spend', 'DirectMail_Spend', 'AltMedia_Spend', 'Video_Spend', 'Display_Spend', 'Print_Spend', 'Social_Imps', 'TV_Imps_AdStock6L3Wk90Ad_Power30',  'Display_Imps_AdStock6L1Wk80Ad_Power40', 'Print_Imps_AdStock13L1Wk30Ad_Power30', 'AltMedia_Imps_AdStock6L5Wk30Ad_Power70']
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Display_ASI_Display_Spend', 'Display_IcmDigital_Display_Spend', 'Display_IcmDigital_Other_Spend', 'Display_MediaCom_Display_Spend', 'Display_MembershipDigital_AmazonDSP_Spend',
 'Display_MembershipDigital_DV360_Spend', 'Display_MembershipDigital_Outbrain_Spend', 'Display_MembershipDigital_Yahoo_Spend', 'Display_ASI_Display_Imps', 'Display_IcmDigital_Display_Imps', 'Display_IcmDigital_Other_Imps', 'Display_MediaCom_Display_Imps', 'Display_MembershipDigital_AmazonDSP_Imps', 'Display_MembershipDigital_DV360_Imps', 'Display_MembershipDigital_Outbrain_Imps', 'Display_MembershipDigital_Yahoo_Imps', 'Display_ASI_Display_Clicks', 'Display_IcmDigital_Display_Clicks', 'Display_IcmDigital_Other_Clicks', 'Display_MediaCom_Display_Clicks', 'Display_MembershipDigital_AmazonDSP_Clicks', 'Display_MembershipDigital_DV360_Clicks',
 'Display_MembershipDigital_Outbrain_Clicks', 'Display_MembershipDigital_Yahoo_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Display.csv')
## Reading Model ##
