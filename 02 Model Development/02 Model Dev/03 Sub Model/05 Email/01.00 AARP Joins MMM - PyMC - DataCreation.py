...
for col in rawdata_df.columns:
  if (col.split('_')[0] == 'Email') & (col.split('_')[-1] == 'Imps'):
    cols.append(col)
cols
...
######### User Input Dict #############
#######################################
cols = ['Email_AcqMail_WinbackEmail_Spend', 'Email_LeadGen_Email_Spend', 'Email_MediaCom_Newsletter_Spend']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date', 'Email_AcqMail_WinbackEmail_Spend', 'Email_LeadGen_Email_Spend', 'Email_MediaCom_Newsletter_Spend']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Email.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Email.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Email_AcqMail_WinbackEmail_Spend', 'Email_LeadGen_Email_Spend', 'Email_MediaCom_Newsletter_Spend', 'Email_AcqMail_WinbackEmail_Imps', 'Email_LeadGen_Email_Imps', 'Email_MediaCom_Newsletter_Imps', 'Email_AcqMail_WinbackEmail_Clicks', 'Email_LeadGen_Email_Clicks', 'Email_MediaCom_Newsletter_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Email.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Email.csv').drop('Unnamed: 0',axis=1)
model_df.head()
