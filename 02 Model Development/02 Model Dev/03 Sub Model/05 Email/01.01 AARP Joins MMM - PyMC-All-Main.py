...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Email.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
model_cols = [
'Email_AcqMail_WinbackEmail_Spend_AdStock6L1Wk20Ad_Power90', 
'Email_LeadGen_Email_Spend_AdStock6L1Wk20Ad_Power90', 
'Email_MediaCom_Newsletter_Spend_AdStock6L1Wk20Ad_Power90'
]

data_cols = [

'Email_AcqMail_WinbackEmail_Spend', 
'Email_LeadGen_Email_Spend', 
'Email_MediaCom_Newsletter_Spend'
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       email_winbackemail_idx = pm.MutableData('email_winbackemail_idx', model_df['Email_AcqMail_WinbackEmail_Spend_AdStock6L1Wk20Ad_Power90'].values, dims='obs_id')
       email_leadgen_idx = pm.MutableData('email_leadgen_idx', model_df['Email_LeadGen_Email_Spend_AdStock6L1Wk20Ad_Power90'].values, dims='obs_id')
       # email_newsletter_idx = pm.MutableData('email_newsletter_idx', model_df['Email_MediaCom_Newsletter_Spend_AdStock6L1Wk20Ad_Power90'].values, dims='obs_id')
       ...
       beta_winbackemail_email  = pm.Uniform('beta_winbackemail_email', lower= 0.02469/20 - 0.0001,upper=0.02469/20 + 0.0001)  #pm.Normal('beta_winbackemail_email', mu= 0.059/3,sigma=0.005)  
       beta_leadgen_email  = pm.Normal('beta_leadgen_email', mu= 0.059/3,sigma=0.005)  
       # beta_newsletter_email  = pm.Uniform('beta_newsletter_email', lower = 0.059/100 - 0.0001,upper = 0.059/100 + 0.0001) #pm.Normal('beta_newsletter_email', mu= 0.059/3,sigma=0.005) 
       ...
       y_hat = intercept_re[dma_idx] + beta_search*search_idx + beta_social*social_idx + beta_PromoEvnt_22MembDrive*PromoEvnt_22MembDrive_idx + beta_PromoEvnt_22BlackFriday*PromoEvnt_22BlackFriday_idx + beta_PromoEvnt_23MembDrive*PromoEvnt_23MembDrive_idx + beta_PromoEvnt_23BlackFriday*PromoEvnt_23BlackFriday_idx + beta_Seasonality_Mar*Seasonality_Mar_idx + beta_Seasonality_Apr*Seasonality_Apr_idx + beta_Seasonality_Feb*Seasonality_Feb_idx + beta_Seasonality_Dec*Seasonality_Dec_idx + beta_July0422_lag*July0422_lag_idx + beta_leadgen*leadgen_idx + beta_tv*tv_idx + beta_AltMedia*AltMedia_idx + beta_dm *dm_idx + beta_winbackemail_email*email_winbackemail_idx + beta_leadgen_email*email_leadgen_idx
...
'beta_winbackemail_email':'Email_AcqMail_WinbackEmail_Spend_AdStock6L1Wk20Ad_Power90', 
'beta_leadgen_email':'Email_LeadGen_Email_Spend_AdStock6L1Wk20Ad_Power90', 
# 'beta_newsletter_email':'Email_MediaCom_Newsletter_Spend_AdStock6L1Wk20Ad_Power90',
