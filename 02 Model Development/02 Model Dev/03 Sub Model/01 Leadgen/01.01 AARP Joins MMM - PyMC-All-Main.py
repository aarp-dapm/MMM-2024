...
model_cols = [
'LeadGen_LeadGen_CARDLINKING_Imps_AdStock6L1Wk60Ad_Power80',
'LeadGen_LeadGen_CoRegLeads_Imps_AdStock6L1Wk60Ad_Power80',
'LeadGen_LeadGen_Impact_Imps_AdStock6L1Wk60Ad_Power80',
'LeadGen_LeadGen_Linkouts_Imps_AdStock6L1Wk60Ad_Power80',
'LeadGen_LeadGen_MajorRocket_Imps_AdStock6L1Wk60Ad_Power80',
'LeadGen_LeadGen_OfferWalls_Imps_AdStock6L1Wk60Ad_Power80'
]

data_cols = [
'LeadGen_LeadGen_CARDLINKING_Spend',
'LeadGen_LeadGen_CoRegLeads_Spend',
'LeadGen_LeadGen_Impact_Spend',
'LeadGen_LeadGen_Linkouts_Spend',
'LeadGen_LeadGen_MajorRocket_Spend',
'LeadGen_LeadGen_OfferWalls_Spend'
]
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       leadgen_cardlinking_idx = pm.MutableData('leadgen_cardlinking_idx', model_df['LeadGen_LeadGen_CARDLINKING_Imps_AdStock6L1Wk60Ad_Power80'].values, dims='obs_id')
       leadgen_coregleads_idx = pm.MutableData('leadgen_coregleads_idx', model_df['LeadGen_LeadGen_CoRegLeads_Imps_AdStock6L1Wk60Ad_Power80'].values, dims='obs_id')
       leadgen_impact_idx = pm.MutableData('leadgen_impact_idx', model_df['LeadGen_LeadGen_Impact_Imps_AdStock6L1Wk60Ad_Power80'].values, dims='obs_id')
       leadgen_linkouts_idx = pm.MutableData('leadgen_linkouts_idx', model_df['LeadGen_LeadGen_Linkouts_Imps_AdStock6L1Wk60Ad_Power80'].values, dims='obs_id')
       leadgen_majorrocket_idx = pm.MutableData('leadgen_majorrocket_idx', model_df['LeadGen_LeadGen_MajorRocket_Imps_AdStock6L1Wk60Ad_Power80'].values, dims='obs_id')
       leadgen_offerwalls_idx = pm.MutableData('leadgen_offerwalls_idx', model_df['LeadGen_LeadGen_OfferWalls_Imps_AdStock6L1Wk60Ad_Power80'].values, dims='obs_id')
       ...
       beta_leadgen_cardlinking =  pm.Normal('beta_leadgen_cardlinking', mu= 0.21*(0.13),sigma=0.007) 
       beta_leadgen_coregleads =  pm.Uniform('beta_leadgen_coregleads', lower= 0.21*(0.11) - 0.014,upper= 0.21*(0.11) + 0.014)
       beta_leadgen_impact =  pm.Normal('beta_leadgen_impact', mu= 0.21*(0.46),sigma=0.007)
       beta_leadgen_linkouts =  pm.Normal('beta_leadgen_linkouts', mu= 0.21*(0.04),sigma=0.007)
       beta_leadgen_majorrocket =  pm.Normal('beta_leadgen_majorrocket', mu= 0.21*(0.22),sigma=0.007)
       beta_leadgen_offerwalls =  pm.Normal('beta_leadgen_offerwalls', mu= 0.21*(0.04),sigma=0.007)
       ...
       y_hat = intercept_re[dma_idx] + beta_tv*tv_idx + beta_search*search_idx + beta_social*social_idx + beta_email*email_idx + beta_dm*dm_idx + beta_AltMedia*AltMedia_idx + beta_PromoEvnt_22MembDrive*PromoEvnt_22MembDrive_idx + beta_PromoEvnt_22BlackFriday*PromoEvnt_22BlackFriday_idx + beta_PromoEvnt_23MembDrive*PromoEvnt_23MembDrive_idx + beta_PromoEvnt_23BlackFriday*PromoEvnt_23BlackFriday_idx + beta_Seasonality_Mar*Seasonality_Mar_idx + beta_Seasonality_Apr*Seasonality_Apr_idx + beta_Seasonality_Feb*Seasonality_Feb_idx + beta_Seasonality_Dec*Seasonality_Dec_idx + beta_July0422_lag*July0422_lag_idx + beta_leadgen_cardlinking*leadgen_cardlinking_idx + beta_leadgen_coregleads*leadgen_coregleads_idx + beta_leadgen_impact*leadgen_impact_idx + beta_leadgen_linkouts*leadgen_linkouts_idx + beta_leadgen_majorrocket*leadgen_majorrocket_idx + beta_leadgen_offerwalls*leadgen_offerwalls_idx
...
'beta_leadgen_cardlinking':'LeadGen_LeadGen_CARDLINKING_Imps_AdStock6L1Wk60Ad_Power80',
'beta_leadgen_coregleads':'LeadGen_LeadGen_CoRegLeads_Imps_AdStock6L1Wk60Ad_Power80',
'beta_leadgen_impact':'LeadGen_LeadGen_Impact_Imps_AdStock6L1Wk60Ad_Power80',
'beta_leadgen_linkouts':'LeadGen_LeadGen_Linkouts_Imps_AdStock6L1Wk60Ad_Power80',
'beta_leadgen_majorrocket':'LeadGen_LeadGen_MajorRocket_Imps_AdStock6L1Wk60Ad_Power80',
'beta_leadgen_offerwalls':'LeadGen_LeadGen_OfferWalls_Imps_AdStock6L1Wk60Ad_Power80',
