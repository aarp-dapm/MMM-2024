...
for col in model_df.columns:
  if col.startswith('Search_ASI_') and col.split("_")[-1] in ['Spend', 'Imps', 'Clicks']:
    print(col)
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       search_asi_Bing_idx = pm.MutableData('search_asi_Bing_idx', model_df['Search_ASI_Bing_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       search_asi_Google_idx = pm.MutableData('search_asi_Google_idx', model_df['Search_ASI_Google_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       ...
       beta_asi_Bing_search =  pm.Uniform('beta_asi_Bing_search', lower = 0.085*0.13*0.06-0.0003,upper = 0.085*0.13*0.06+0.0003)
       beta_asi_Google_search =  pm.Uniform('beta_asi_Google_search', lower = 0.085*0.13*0.94-0.008,upper = 0.085*0.13*0.94+0.008)
