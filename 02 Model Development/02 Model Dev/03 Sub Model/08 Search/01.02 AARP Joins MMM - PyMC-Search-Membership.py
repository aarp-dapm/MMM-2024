...
for col in model_df.columns:
  if col.startswith('Search_MembershipDigital_') and col.split("_")[-1] in ['Spend', 'Imps', 'Clicks']:
    print(col)
...
model_cols = [
'Search_MembershipDigital_Bing_Clicks_AdStock6L1Wk90Ad_Power90', 'Search_MembershipDigital_GoogleDiscovery_Clicks_AdStock6L1Wk90Ad_Power90', 'Search_MembershipDigital_GooglePerfMax_Clicks_AdStock6L1Wk90Ad_Power90', 'Search_MembershipDigital_GoogleSearch_Clicks_AdStock6L1Wk90Ad_Power90', 'Search_MembershipDigital_YouTubeTrueView_Clicks_AdStock6L1Wk90Ad_Power90'
]

data_cols = [

'Search_MembershipDigital_Bing_Spend', 'Search_MembershipDigital_GoogleDiscovery_Spend', 'Search_MembershipDigital_GooglePerfMax_Spend', 'Search_MembershipDigital_GoogleSearch_Spend', 'Search_MembershipDigital_YouTubeTrueView_Spend'
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       search_MembershipDigital_Bing_idx = pm.MutableData('search_MembershipDigital_Bing_idx', model_df['Search_MembershipDigital_Bing_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       search_MembershipDigital_GoogleDiscovery_idx = pm.MutableData('search_MembershipDigital_GoogleDiscovery_idx', model_df['Search_MembershipDigital_GoogleDiscovery_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       search_MembershipDigital_GooglePerfMax_idx = pm.MutableData('search_MembershipDigital_GooglePerfMax_idx', model_df['Search_MembershipDigital_GooglePerfMax_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       search_MembershipDigital_GoogleSearch_idx = pm.MutableData('search_MembershipDigital_GoogleSearch_idx', model_df['Search_MembershipDigital_GoogleSearch_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       search_MembershipDigital_YouTubeTrueView_idx = pm.MutableData('search_MembershipDigital_YouTubeTrueView_idx', model_df['Search_MembershipDigital_YouTubeTrueView_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       ...
       beta_MembershipDigital_Bing_search =  pm.Uniform('beta_MembershipDigital_Bing_search', lower = 0.085*0.61*.10-0.002,upper = 0.085*0.61*.10+0.002)
       beta_MembershipDigital_GoogleDiscovery_search =  pm.Uniform('beta_MembershipDigital_GoogleDiscovery_search', lower = 0.085*0.61*0.03-0.001,upper = 0.085*0.61*0.03+0.001)
       beta_MembershipDigital_GooglePerfMax_search =  pm.Uniform('beta_MembershipDigital_GooglePerfMax_search', lower = 0.085*0.61*0.05-0.002,upper = 0.085*0.61*0.05+0.002)
       beta_MembershipDigital_GoogleSearch_search =  pm.Uniform('beta_MembershipDigital_GoogleSearch_search', lower = 0.085*0.61*0.75-0.01,upper = 0.085*0.61*0.75+0.01)
       beta_MembershipDigital_YouTubeTrueView_search =  pm.Uniform('beta_MembershipDigital_YouTubeTrueView_search', lower = 0.085*0.61*0.07-0.002,upper = 0.085*0.61*0.07+0.002)
       ...
       y_hat = intercept_re[dma_idx] + beta_social*social_idx + beta_PromoEvnt_22MembDrive*PromoEvnt_22MembDrive_idx + beta_PromoEvnt_22BlackFriday*PromoEvnt_22BlackFriday_idx + beta_PromoEvnt_23MembDrive*PromoEvnt_23MembDrive_idx + beta_PromoEvnt_23BlackFriday*PromoEvnt_23BlackFriday_idx + beta_Seasonality_Mar*Seasonality_Mar_idx + beta_Seasonality_Apr*Seasonality_Apr_idx + beta_Seasonality_Feb*Seasonality_Feb_idx + beta_Seasonality_Dec*Seasonality_Dec_idx + beta_July0422_lag*July0422_lag_idx + beta_leadgen*leadgen_idx + beta_tv*tv_idx + beta_AltMedia*AltMedia_idx + beta_dm *dm_idx + beta_email*email_idx + beta_MediaCom_search*search_MediaCom_idx + beta_IcmDigital_search*search_IcmDigital_idx + beta_asi_search*search_asi_idx + beta_MembershipDigital_Bing_search*search_MembershipDigital_Bing_idx + beta_MembershipDigital_GoogleDiscovery_search*search_MembershipDigital_GoogleDiscovery_idx + beta_MembershipDigital_GooglePerfMax_search*search_MembershipDigital_GooglePerfMax_idx + beta_MembershipDigital_GoogleSearch_search*search_MembershipDigital_GoogleSearch_idx + beta_MembershipDigital_YouTubeTrueView_search*search_MembershipDigital_YouTubeTrueView_idx
