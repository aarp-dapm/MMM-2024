...
for col in model_df.columns:
  if col.startswith('Search_MediaCom_') and col.split("_")[-1] in ['Spend', 'Imps', 'Clicks']:
    print(col)
...
model_cols = [
'Search_MediaCom_Bing_Clicks_AdStock6L1Wk90Ad_Power90', 'Search_MediaCom_Google_Clicks_AdStock6L1Wk90Ad_Power90'
]

data_cols = [

'Search_MediaCom_Bing_Spend', 'Search_MediaCom_Google_Spend'
