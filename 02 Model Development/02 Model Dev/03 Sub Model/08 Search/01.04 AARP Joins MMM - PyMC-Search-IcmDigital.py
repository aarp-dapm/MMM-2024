...
for col in model_df.columns:
  if col.startswith('Search_IcmDigital_') and col.split("_")[-1] in ['Spend', 'Imps', 'Clicks']:
    print(col)
...
model_cols = [
'Search_IcmDigital_BingSearch_Clicks_AdStock6L1Wk90Ad_Power90', 'Search_IcmDigital_GoogleSearch_Clicks_AdStock6L1Wk90Ad_Power90'
]

data_cols = [

'Search_IcmDigital_BingSearch_Spend', 'Search_IcmDigital_GoogleSearch_Spend'
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       search_IcmDigital_Bing_idx = pm.MutableData('search_IcmDigital_Bing_idx', model_df['Search_IcmDigital_BingSearch_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       search_IcmDigital_Google_idx = pm.MutableData('search_IcmDigital_Google_idx', model_df['Search_IcmDigital_GoogleSearch_Clicks_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       ...
       beta_IcmDigital_BingSearch_search =  pm.Uniform('beta_IcmDigital_BingSearch_search', lower = 0.085*0.19*0.43-0.003,upper = 0.085*0.19*0.43+0.003)
       beta_IcmDigital_GoogleSearch_search =  pm.Uniform('beta_IcmDigital_GoogleSearch_search', lower = 0.085*0.19*0.57-0.002,upper = 0.085*0.19*0.57+0.002)
