...
for col in rawdata_df.columns:
  if (col.split('_')[0] == 'Search') & (col.split('_')[-1] in ['Clicks', 'Imps', 'Spend']):
    cols.append(col)
cols
...
### Membership ###
rawdata_df['Search_MembershipDigital_Spend'] = rawdata_df[['Search_MembershipDigital_Bing_Spend', 'Search_MembershipDigital_GoogleDiscovery_Spend', 'Search_MembershipDigital_GooglePerfMax_Spend', 'Search_MembershipDigital_GoogleSearch_Spend', 'Search_MembershipDigital_YouTubeTrueView_Spend']].sum(axis=1)
rawdata_df['Search_MembershipDigital_Imps'] = rawdata_df[['Search_MembershipDigital_Bing_Imps', 'Search_MembershipDigital_GoogleDiscovery_Imps', 'Search_MembershipDigital_GooglePerfMax_Imps', 'Search_MembershipDigital_GoogleSearch_Imps', 'Search_MembershipDigital_YouTubeTrueView_Imps']].sum(axis=1)
rawdata_df['Search_MembershipDigital_Clicks'] = rawdata_df[['Search_MembershipDigital_Bing_Clicks', 'Search_MembershipDigital_GoogleDiscovery_Clicks', 'Search_MembershipDigital_GooglePerfMax_Clicks', 'Search_MembershipDigital_GoogleSearch_Clicks', 'Search_MembershipDigital_YouTubeTrueView_Clicks']].sum(axis=1)


### Media Com ###
rawdata_df['Search_MediaCom_Spend']=rawdata_df[['Search_MediaCom_Bing_Spend', 'Search_MediaCom_Google_Spend']].sum(axis=1)
rawdata_df['Search_MediaCom_Imps'] = rawdata_df[['Search_MediaCom_Bing_Imps', 'Search_MediaCom_Google_Imps']].sum(axis=1)
rawdata_df['Search_MediaCom_Clicks'] = rawdata_df[['Search_MediaCom_Bing_Clicks', 'Search_MediaCom_Google_Clicks']].sum(axis=1)



### ICM Digital ###
rawdata_df['Search_IcmDigital_Spend'] = rawdata_df[['Search_IcmDigital_BingSearch_Spend', 'Search_IcmDigital_GoogleSearch_Spend']].sum(axis=1)
rawdata_df['Search_IcmDigital_Imps'] = rawdata_df[['Search_IcmDigital_BingSearch_Imps', 'Search_IcmDigital_GoogleSearch_Imps']].sum(axis=1)
rawdata_df['Search_IcmDigital_Clicks'] = rawdata_df[['Search_IcmDigital_BingSearch_Clicks', 'Search_IcmDigital_GoogleSearch_Clicks']].sum(axis=1)



rawdata_df['Search_ASI_Spend'] = rawdata_df[['Search_ASI_Bing_Spend', 'Search_ASI_Google_Spend', 'Search_ASI_Unknown_Spend']].sum(axis=1)
rawdata_df['Search_ASI_Imps'] = rawdata_df[['Search_ASI_Bing_Imps', 'Search_ASI_Google_Imps', 'Search_ASI_Unknown_Imps']].sum(axis=1)
rawdata_df['Search_ASI_Clicks'] = rawdata_df[['Search_ASI_Bing_Clicks', 'Search_ASI_Google_Clicks', 'Search_ASI_Unknown_Clicks']].sum(axis=1)
...
######### User Input Dict #############
#######################################
cols = ['Search_MembershipDigital_Clicks', 'Search_MediaCom_Clicks', 'Search_IcmDigital_Clicks', 'Search_ASI_Clicks']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','Search_MembershipDigital_Clicks', 'Search_MediaCom_Clicks', 'Search_IcmDigital_Clicks', 'Search_ASI_Clicks']]
# MAGIC
...
## Saving Model ##
# transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Search.csv')
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_BuyingGroup_Search.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_BuyingGroup_Search.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Search_ASI_Bing_Spend', 'Search_ASI_Google_Spend', 'Search_ASI_Unknown_Spend', 'Search_IcmDigital_BingSearch_Spend', 'Search_IcmDigital_GoogleSearch_Spend', 'Search_MediaCom_Bing_Spend',
 'Search_MediaCom_Google_Spend', 'Search_MembershipDigital_Bing_Spend', 'Search_MembershipDigital_GoogleDiscovery_Spend', 'Search_MembershipDigital_GooglePerfMax_Spend',
 'Search_MembershipDigital_GoogleSearch_Spend', 'Search_MembershipDigital_YouTubeTrueView_Spend',
 'Search_ASI_Bing_Imps', 'Search_ASI_Google_Imps', 'Search_ASI_Unknown_Imps', 'Search_IcmDigital_BingSearch_Imps', 'Search_IcmDigital_GoogleSearch_Imps', 'Search_MediaCom_Bing_Imps', 'Search_MediaCom_Google_Imps',
 'Search_MembershipDigital_Bing_Imps', 'Search_MembershipDigital_GoogleDiscovery_Imps', 'Search_MembershipDigital_GooglePerfMax_Imps', 'Search_MembershipDigital_GoogleSearch_Imps','Search_MembershipDigital_YouTubeTrueView_Imps',
 'Search_ASI_Bing_Clicks', 'Search_ASI_Google_Clicks', 'Search_ASI_Unknown_Clicks', 'Search_IcmDigital_BingSearch_Clicks', 'Search_IcmDigital_GoogleSearch_Clicks', 'Search_MediaCom_Bing_Clicks',
 'Search_MediaCom_Google_Clicks', 'Search_MembershipDigital_Bing_Clicks', 'Search_MembershipDigital_GoogleDiscovery_Clicks', 'Search_MembershipDigital_GooglePerfMax_Clicks', 'Search_MembershipDigital_GoogleSearch_Clicks',
 'Search_MembershipDigital_YouTubeTrueView_Clicks']
...
## Creating New Columns ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Search.csv').drop('Unnamed: 0',axis=1)
transformed_df['Date'] = pd.to_datetime(transformed_df['Date'])
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Search.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Search.csv').drop('Unnamed: 0',axis=1)
model_df.head()
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_BuyingGroup_Search.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_BuyingGroup_Search.csv').drop('Unnamed: 0',axis=1)
model_df.head()
