...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Video.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
'Video_IcmDigital_Native_Spend', 
'Video_IcmDigital_YouTube_Spend', 
'Video_MediaCom_OLV_Spend', 
'Video_MediaCom_YouTube_Spend'
