...
for col in rawdata_df.columns:
  if (col.split('_')[0] == 'Video') & (col.split('_')[-1] == 'Imps'):
    cols.append(col)
cols
...
######### User Input Dict #############
#######################################
cols = ['Video_IcmDigital_Native_Imps', 'Video_IcmDigital_YouTube_Imps', 'Video_MediaCom_OLV_Imps', 'Video_MediaCom_YouTube_Imps']
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date', 'Video_IcmDigital_Native_Imps', 'Video_IcmDigital_YouTube_Imps', 'Video_MediaCom_OLV_Imps', 'Video_MediaCom_YouTube_Imps']]
# MAGIC
...
## Saving Model ##
# transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Video.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Video.csv').drop('Unnamed: 0',axis=1)
...
main_model_cols_spend = ['TV_Spend', 'Search_Spend', 'Social_Spend', 'LeadGen_Spend', 'Email_Spend', 'DirectMail_Spend', 'AltMedia_Spend', 'Video_Spend', 'Display_Spend', 'Print_Spend', 'Social_Imps', 'TV_Imps_AdStock6L3Wk90Ad_Power30']
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Video_IcmDigital_Native_Spend', 'Video_IcmDigital_YouTube_Spend', 'Video_MediaCom_OLV_Spend', 'Video_MediaCom_YouTube_Spend', 'Video_IcmDigital_Native_Imps', 'Video_IcmDigital_YouTube_Imps', 'Video_MediaCom_OLV_Imps', 'Video_MediaCom_YouTube_Imps', 'Video_IcmDigital_Native_Clicks', 'Video_IcmDigital_YouTube_Clicks', 'Video_MediaCom_OLV_Clicks', 'Video_MediaCom_YouTube_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Video.csv')
## Reading Model ##
