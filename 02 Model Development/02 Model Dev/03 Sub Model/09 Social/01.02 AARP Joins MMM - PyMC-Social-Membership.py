...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_BuyingGroupNDnextdoorSpend_Social.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
### Membership ###
model_df['Social_MembershipDigital_Spend'] = model_df[['Social_MembershipDigital_Facebook_Spend', 'Social_MembershipDigital_Instagram_Spend', 'Social_MembershipDigital_Linkedin_Spend', 'Social_MembershipDigital_Nextdoor_Spend', 'Social_MembershipDigital_Reddit_Spend', 'Social_MembershipDigital_TikTok_Spend']].sum(axis=1)
model_df['Social_MembershipDigital_Imps'] = model_df[['Social_MembershipDigital_Facebook_Imps', 'Social_MembershipDigital_Instagram_Imps', 'Social_MembershipDigital_Linkedin_Imps',
'Social_MembershipDigital_Nextdoor_Imps', 'Social_MembershipDigital_Reddit_Imps', 'Social_MembershipDigital_TikTok_Imps']].sum(axis=1)
model_df['Social_MembershipDigital_Clicks'] = model_df[['Social_MembershipDigital_Facebook_Clicks', 'Social_MembershipDigital_Instagram_Clicks', 'Social_MembershipDigital_Linkedin_Clicks',
'Social_MembershipDigital_Nextdoor_Clicks', 'Social_MembershipDigital_Reddit_Clicks', 'Social_MembershipDigital_TikTok_Clicks']].sum(axis=1)


### Media Com ###
model_df['Social_MediaCom_Spend'] = model_df[['Social_MediaCom_Meta_Spend', 'Social_MediaCom_TikTok_Spend', 'Social_MediaCom_X_Spend']].sum(axis=1)
model_df['Social_MediaCom_Imps'] = model_df[['Social_MediaCom_Meta_Imps', 'Social_MediaCom_TikTok_Imps', 'Social_MediaCom_X_Imps']].sum(axis=1)
model_df['Social_MediaCom_Clicks'] = model_df[['Social_MediaCom_Meta_Clicks', 'Social_MediaCom_TikTok_Clicks', 'Social_MediaCom_X_Clicks']].sum(axis=1)

### Icm Digital ###
model_df['Social_IcmDigital_Spend'] = model_df[['Social_IcmDigital_Facebook_Spend']].sum(axis=1)
model_df['Social_IcmDigital_Imps'] = model_df[['Social_IcmDigital_Facebook_Imps']].sum(axis=1)
model_df['Social_IcmDigital_Clicks'] = model_df[['Social_IcmDigital_Facebook_Clicks']].sum(axis=1)

### Icm Social ###
model_df['Social_IcmSocial_Spend'] = model_df[['Social_IcmSocial_FacebookAudienceNetwork_Spend', 'Social_IcmSocial_FacebookMessenger_Spend', 'Social_IcmSocial_Facebook_Spend', 'Social_IcmSocial_Instagram_Spend', 'Social_IcmSocial_LinkedIn_Spend', 'Social_IcmSocial_Pinterest_Spend', 'Social_IcmSocial_TikTok_Spend', 'Social_IcmSocial_Twitter_Spend', 'Social_IcmSocial_messenger_Spend', 'Social_IcmSocial_unknown_Spend']].sum(axis=1)
model_df['Social_IcmSocial_Imps'] = model_df[['Social_IcmSocial_FacebookAudienceNetwork_Imps', 'Social_IcmSocial_FacebookMessenger_Imps', 'Social_IcmSocial_Facebook_Imps', 'Social_IcmSocial_Instagram_Imps', 'Social_IcmSocial_LinkedIn_Imps', 'Social_IcmSocial_Pinterest_Imps', 'Social_IcmSocial_TikTok_Imps', 'Social_IcmSocial_Twitter_Imps', 'Social_IcmSocial_messenger_Imps', 'Social_IcmSocial_unknown_Imps']].sum(axis=1)
model_df['Social_IcmSocial_Clicks'] = model_df[['Social_IcmSocial_FacebookAudienceNetwork_Clicks', 'Social_IcmSocial_FacebookMessenger_Clicks', 'Social_IcmSocial_Facebook_Clicks', 'Social_IcmSocial_Instagram_Clicks', 'Social_IcmSocial_Pinterest_Clicks', 'Social_IcmSocial_TikTok_Clicks', 'Social_IcmSocial_Twitter_Clicks', 'Social_IcmSocial_messenger_Clicks', 'Social_IcmSocial_unknown_Clicks']].sum(axis=1)

### ASI ###
model_df['Social_ASI_Spend'] = model_df[['Social_ASI_Meta_Spend']].sum(axis=1)
model_df['Social_ASI_Imps'] = model_df[['Social_ASI_Meta_Imps']].sum(axis=1)
model_df['Social_ASI_Clicks'] = model_df[['Social_ASI_Meta_Clicks']].sum(axis=1)
...
for col in model_df.columns:
  if col.startswith('Social_MembershipDigital_') and col.split("_")[-1] in ['Spend', 'Imps', 'Clicks']:
    print(col)
...
model_cols = [
  'Social_MembershipDigital_Facebook_Imps_AdStock6L1Wk90Ad_Power90', 'Social_MembershipDigital_Instagram_Imps_AdStock6L1Wk90Ad_Power90', 'Social_MembershipDigital_Linkedin_Imps_AdStock6L1Wk90Ad_Power90', 'Social_MembershipDigital_Nextdoor_Spend_AdStock6L1Wk90Ad_Power90', 'Social_MembershipDigital_Reddit_Imps_AdStock6L1Wk90Ad_Power90', 'Social_MembershipDigital_TikTok_Imps_AdStock6L1Wk90Ad_Power90'

]

data_cols = [
'Social_MembershipDigital_Facebook_Spend', 'Social_MembershipDigital_Instagram_Spend', 'Social_MembershipDigital_Linkedin_Spend', 'Social_MembershipDigital_Nextdoor_Spend', 'Social_MembershipDigital_Reddit_Spend',
'Social_MembershipDigital_TikTok_Spend'
]
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       # social_MembershipDigital_idx = pm.MutableData('social_MembershipDigital_idx', model_df['Social_MembershipDigital_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_MembershipDigital_Facebook_idx = pm.MutableData('social_MembershipDigital_Facebook_idx', model_df['Social_MembershipDigital_Facebook_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_MembershipDigital_Instagram_idx = pm.MutableData('social_MembershipDigital_Instagram_idx', model_df['Social_MembershipDigital_Instagram_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_MembershipDigital_Linkedin_idx = pm.MutableData('social_MembershipDigital_Linkedin_idx', model_df['Social_MembershipDigital_Linkedin_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_MembershipDigital_Nextdoor_idx = pm.MutableData('social_MembershipDigital_Nextdoor_idx', model_df['Social_MembershipDigital_Nextdoor_Spend_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_MembershipDigital_Reddit_idx = pm.MutableData('social_MembershipDigital_Reddit_idx', model_df['Social_MembershipDigital_Reddit_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_MembershipDigital_TikTok_idx = pm.MutableData('social_MembershipDigital_TikTok_idx', model_df['Social_MembershipDigital_TikTok_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')





       social_MediaCom_idx = pm.MutableData('social_MediaCom_idx', model_df['Social_MediaCom_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_IcmDigital_idx = pm.MutableData('social_IcmDigital_idx', model_df['Social_IcmDigital_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_IcmSocial_idx = pm.MutableData('social_IcmSocial_idx', model_df['Social_IcmSocial_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_ASI_idx = pm.MutableData('social_ASI_idx', model_df['Social_ASI_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       ...
       # beta_MembershipDigital_social =  pm.Uniform('beta_MembershipDigital_social', lower= 0.029*0.49 - 0.005,upper=0.029*0.49 + 0.005) #pm.Normal('beta_MembershipDigital_social', mu= 0.029/5,sigma=0.007)
       beta_MembershipDigital_Facebook_social =  pm.Uniform('beta_MembershipDigital_Facebook_social', lower= 0.029*0.49*0.81 - 0.005,upper=0.029*0.49*0.81 + 0.005)
       beta_MembershipDigital_Instagram_social =  pm.Uniform('beta_MembershipDigital_Instagram_social', lower= 0.029*0.49*0.12 - 0.0005,upper=0.029*0.49*0.12 + 0.0005)
       beta_MembershipDigital_Linkedin_social =  pm.Uniform('beta_MembershipDigital_Linkedin_social', lower= 0.029*0.49*0.01 - 0.0001,upper=0.029*0.49*0.01 + 0.0001)
       beta_MembershipDigital_Nextdoor_social =  pm.Uniform('beta_MembershipDigital_Nextdoor_social', lower= 0.029*0.49*0.05 - 0.0001,upper=0.029*0.49*0.05 + 0.0001)
       beta_MembershipDigital_Reddit_social =  pm.Uniform('beta_MembershipDigital_Reddit_social', lower= 0.029*0.49*0.01 - 0.0001,upper=0.029*0.49*0.01 + 0.0001)
       beta_MembershipDigital_TikTok_social =  pm.Uniform('beta_MembershipDigital_TikTok_social', lower= 0.029*0.49*0.01 - 0.0001,upper=0.029*0.49*0.01 + 0.0001)




       beta_MediaCom_social =  pm.Uniform('beta_MediaCom_social', lower= 0.029*0.08 - 0.002,upper=0.029*0.08 + 0.002)
       beta_IcmDigital_social =  pm.Uniform('beta_IcmDigital_social', lower= 0.0001,upper=0.00015)
       beta_IcmSocial_social =  pm.Uniform('beta_IcmSocial_social', lower= 0.029*0.32 - 0.002,upper=0.029*0.32 + 0.002)
       beta_ASI_social =  pm.Uniform('beta_ASI_social', lower= 0.029*0.1 - 0.001,upper=0.029*0.1 + 0.001)
       ...
       y_hat = intercept_re[dma_idx] + beta_PromoEvnt_22MembDrive*PromoEvnt_22MembDrive_idx + beta_PromoEvnt_22BlackFriday*PromoEvnt_22BlackFriday_idx + beta_PromoEvnt_23MembDrive*PromoEvnt_23MembDrive_idx + beta_PromoEvnt_23BlackFriday*PromoEvnt_23BlackFriday_idx + beta_Seasonality_Mar*Seasonality_Mar_idx + beta_Seasonality_Apr*Seasonality_Apr_idx + beta_Seasonality_Feb*Seasonality_Feb_idx + beta_Seasonality_Dec*Seasonality_Dec_idx + beta_July0422_lag*July0422_lag_idx + beta_leadgen*leadgen_idx + beta_tv*tv_idx + beta_AltMedia*AltMedia_idx + beta_dm *dm_idx + beta_email*email_idx + beta_search*search_idx + beta_ASI_social*social_ASI_idx + beta_MediaCom_social*social_MediaCom_idx + beta_IcmDigital_social*social_IcmDigital_idx + beta_IcmSocial_social*social_IcmSocial_idx + beta_MembershipDigital_Facebook_social*social_MembershipDigital_Facebook_idx + beta_MembershipDigital_Instagram_social*social_MembershipDigital_Instagram_idx + beta_MembershipDigital_Linkedin_social*social_MembershipDigital_Linkedin_idx + beta_MembershipDigital_Nextdoor_social*social_MembershipDigital_Nextdoor_idx + beta_MembershipDigital_Reddit_social*social_MembershipDigital_Reddit_idx + beta_MembershipDigital_TikTok_social*social_MembershipDigital_TikTok_idx
...
with varying_intercept:
  varying_intercept_trace = pm.sample(draws=500,tune=100, chains=4, random_seed = RANDOM_SEED, progressbar=True, target_accept=1)

# COMMAND ----------

# Model Summary #
summary_df = az.summary(varying_intercept_trace, round_to=6).reset_index()
summary_df.display()
...
'beta_ASI_social':'Social_ASI_Imps_AdStock6L1Wk90Ad_Power90',
'beta_IcmDigital_social':'Social_IcmDigital_Imps_AdStock6L1Wk90Ad_Power90',
'beta_IcmSocial_social': 'Social_IcmSocial_Imps_AdStock6L1Wk90Ad_Power90',
'beta_MediaCom_social': 'Social_MediaCom_Imps_AdStock6L1Wk90Ad_Power90',


# 'beta_MembershipDigital_social': 'Social_MembershipDigital_Imps_AdStock6L1Wk90Ad_Power90',
'beta_MembershipDigital_Facebook_social':'Social_MembershipDigital_Facebook_Imps_AdStock6L1Wk90Ad_Power90',
'beta_MembershipDigital_Instagram_social':'Social_MembershipDigital_Instagram_Imps_AdStock6L1Wk90Ad_Power90',
'beta_MembershipDigital_Linkedin_social':'Social_MembershipDigital_Linkedin_Imps_AdStock6L1Wk90Ad_Power90',
'beta_MembershipDigital_Nextdoor_social':'Social_MembershipDigital_Nextdoor_Spend_AdStock6L1Wk90Ad_Power90',
'beta_MembershipDigital_Reddit_social':'Social_MembershipDigital_Reddit_Imps_AdStock6L1Wk90Ad_Power90',
'beta_MembershipDigital_TikTok_social':'Social_MembershipDigital_TikTok_Imps_AdStock6L1Wk90Ad_Power90',
...
# 'beta_ASI_Meta_social':'Social_ASI_Meta_Imps_AdStock6L1Wk90Ad_Power90',

# 'beta_IcmDigital_Facebook_social':'Social_IcmDigital_Facebook_Imps_AdStock6L1Wk90Ad_Power90',

# 'beta_IcmSocial_FacebookAudienceNetwork_social':'Social_IcmSocial_FacebookAudienceNetwork_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_IcmSocial_FacebookMessenger_social':'Social_IcmSocial_FacebookMessenger_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_IcmSocial_messenger_social':'Social_IcmSocial_messenger_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_IcmSocial_Facebook_social':'Social_IcmSocial_Facebook_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_IcmSocial_Instagram_social':'Social_IcmSocial_Instagram_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_IcmSocial_LinkedIn_social':'Social_IcmSocial_LinkedIn_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_IcmSocial_Pinterest_social':'Social_IcmSocial_Pinterest_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_IcmSocial_TikTok_social':'Social_IcmSocial_TikTok_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_IcmSocial_Twitter_social':'Social_IcmSocial_Twitter_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_IcmSocial_unknown_social':'Social_IcmSocial_unknown_Imps_AdStock6L1Wk90Ad_Power90',

# 'beta_MediaCom_Meta_social':'Social_MediaCom_Meta_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_MediaCom_TikTok_social':'Social_MediaCom_TikTok_Imps_AdStock6L1Wk90Ad_Power90',
# 'beta_MediaCom_X_social':'Social_MediaCom_X_Imps_AdStock6L1Wk90Ad_Power90',
...
'Social_MediaCom_Imps_AdStock6L1Wk90Ad_Power90', 
...
# 'Social_ASI_Meta_Imps_AdStock6L1Wk90Ad_Power90', 

# 'Social_IcmDigital_Facebook_Imps_AdStock6L1Wk90Ad_Power90', 

# 'Social_IcmSocial_FacebookAudienceNetwork_Imps_AdStock6L1Wk90Ad_Power90', 
# 'Social_IcmSocial_FacebookMessenger_Imps_AdStock6L1Wk90Ad_Power90', 
# 'Social_IcmSocial_messenger_Imps_AdStock6L1Wk90Ad_Power90',
# 'Social_IcmSocial_Facebook_Imps_AdStock6L1Wk90Ad_Power90', 
# 'Social_IcmSocial_Instagram_Imps_AdStock6L1Wk90Ad_Power90',
# 'Social_IcmSocial_LinkedIn_Imps_AdStock6L1Wk90Ad_Power90', 
# 'Social_IcmSocial_Pinterest_Imps_AdStock6L1Wk90Ad_Power90', 
# 'Social_IcmSocial_TikTok_Imps_AdStock6L1Wk90Ad_Power90', 
# 'Social_IcmSocial_Twitter_Imps_AdStock6L1Wk90Ad_Power90', 
# 'Social_IcmSocial_unknown_Imps_AdStock6L1Wk90Ad_Power90',

# 'Social_MediaCom_Meta_Imps_AdStock6L1Wk90Ad_Power90', 
# 'Social_MediaCom_TikTok_Imps_AdStock6L1Wk90Ad_Power90', 
# 'Social_MediaCom_X_Imps_AdStock6L1Wk90Ad_Power90', 

'Social_MembershipDigital_Facebook_Imps_AdStock6L1Wk90Ad_Power90', 
'Social_MembershipDigital_Instagram_Imps_AdStock6L1Wk90Ad_Power90', 
'Social_MembershipDigital_Linkedin_Imps_AdStock6L1Wk90Ad_Power90',
'Social_MembershipDigital_Nextdoor_Spend_AdStock6L1Wk90Ad_Power90', 
'Social_MembershipDigital_Reddit_Imps_AdStock6L1Wk90Ad_Power90', 
'Social_MembershipDigital_TikTok_Imps_AdStock6L1Wk90Ad_Power90',
...
for media in media_vars:
  dict_ = {'ChannelLever': 'Membership', 'Channel': "_".join(media.split("_")[:3]) if "_".join(media.split("_")[:2]) == ch_name else media.split("_")[0], 'Support': "_".join(media.split("_")[:4]) if "_".join(media.split("_")[:2])==ch_name else "_".join(media.split("_")[:2]), 'Transformation': media, 'Contrib_2022': 0,  'Contrib_2023': 0, 'Support_2022': 0,  'Support_2023': 0,  'Spend_2022': 0,  'Spend_2023': 0 }
