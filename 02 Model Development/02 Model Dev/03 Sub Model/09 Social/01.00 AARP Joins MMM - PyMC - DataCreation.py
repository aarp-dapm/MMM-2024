...
for col in rawdata_df.columns:
  if (col.split('_')[0] == 'Social') and col.endswith('Spend'):
    cols.append(col)
cols
...
### Membership ###
rawdata_df['Social_MembershipDigital_Spend'] = rawdata_df[['Social_MembershipDigital_Facebook_Spend', 'Social_MembershipDigital_Instagram_Spend', 'Social_MembershipDigital_Linkedin_Spend', 'Social_MembershipDigital_Nextdoor_Spend', 'Social_MembershipDigital_Reddit_Spend', 'Social_MembershipDigital_TikTok_Spend']].sum(axis=1)
rawdata_df['Social_MembershipDigital_Imps'] = rawdata_df[['Social_MembershipDigital_Facebook_Imps', 'Social_MembershipDigital_Instagram_Imps', 'Social_MembershipDigital_Linkedin_Imps',
...
rawdata_df['Social_MembershipDigital_Clicks'] = rawdata_df[['Social_MembershipDigital_Facebook_Clicks', 'Social_MembershipDigital_Instagram_Clicks', 'Social_MembershipDigital_Linkedin_Clicks',
...
### Media Com ###
rawdata_df['Social_MediaCom_Spend'] = rawdata_df[['Social_MediaCom_Meta_Spend', 'Social_MediaCom_TikTok_Spend', 'Social_MediaCom_X_Spend']].sum(axis=1)
rawdata_df['Social_MediaCom_Imps'] = rawdata_df[['Social_MediaCom_Meta_Imps', 'Social_MediaCom_TikTok_Imps', 'Social_MediaCom_X_Imps']].sum(axis=1)
rawdata_df['Social_MediaCom_Clicks'] = rawdata_df[['Social_MediaCom_Meta_Clicks', 'Social_MediaCom_TikTok_Clicks', 'Social_MediaCom_X_Clicks']].sum(axis=1)

### Icm Digital ###
rawdata_df['Social_IcmDigital_Spend'] = rawdata_df[['Social_IcmDigital_Facebook_Spend']].sum(axis=1)
rawdata_df['Social_IcmDigital_Imps'] = rawdata_df[['Social_IcmDigital_Facebook_Imps']].sum(axis=1)
rawdata_df['Social_IcmDigital_Clicks'] = rawdata_df[['Social_IcmDigital_Facebook_Clicks']].sum(axis=1)

### Icm Social ###
rawdata_df['Social_IcmSocial_Spend'] = rawdata_df[['Social_IcmSocial_FacebookAudienceNetwork_Spend', 'Social_IcmSocial_FacebookMessenger_Spend', 'Social_IcmSocial_Facebook_Spend', 'Social_IcmSocial_Instagram_Spend', 'Social_IcmSocial_LinkedIn_Spend', 'Social_IcmSocial_Pinterest_Spend', 'Social_IcmSocial_TikTok_Spend', 'Social_IcmSocial_Twitter_Spend', 'Social_IcmSocial_messenger_Spend', 'Social_IcmSocial_unknown_Spend']].sum(axis=1)
rawdata_df['Social_IcmSocial_Imps'] = rawdata_df[['Social_IcmSocial_FacebookAudienceNetwork_Imps', 'Social_IcmSocial_FacebookMessenger_Imps', 'Social_IcmSocial_Facebook_Imps', 'Social_IcmSocial_Instagram_Imps', 'Social_IcmSocial_LinkedIn_Imps', 'Social_IcmSocial_Pinterest_Imps', 'Social_IcmSocial_TikTok_Imps', 'Social_IcmSocial_Twitter_Imps', 'Social_IcmSocial_messenger_Imps', 'Social_IcmSocial_unknown_Imps']].sum(axis=1)
rawdata_df['Social_IcmSocial_Clicks'] = rawdata_df[['Social_IcmSocial_FacebookAudienceNetwork_Clicks', 'Social_IcmSocial_FacebookMessenger_Clicks', 'Social_IcmSocial_Facebook_Clicks', 'Social_IcmSocial_Instagram_Clicks', 'Social_IcmSocial_Pinterest_Clicks', 'Social_IcmSocial_TikTok_Clicks', 'Social_IcmSocial_Twitter_Clicks', 'Social_IcmSocial_messenger_Clicks', 'Social_IcmSocial_unknown_Clicks']].sum(axis=1)

### ASI ###
rawdata_df['Social_ASI_Spend'] = rawdata_df[['Social_ASI_Meta_Spend']].sum(axis=1)
rawdata_df['Social_ASI_Imps'] = rawdata_df[['Social_ASI_Meta_Imps']].sum(axis=1)
rawdata_df['Social_ASI_Clicks'] = rawdata_df[['Social_ASI_Meta_Clicks']].sum(axis=1)
...
#######################################
cols = [
   'Social_MembershipDigital_Nextdoor_Spend'
 ]
input_dict ={col : {'Adstock':{'week_cutoff':[6,13], 'peak_week':[1,2,3,4,5], 'decay_rate': list(frange(0.1,0.9,0.1))}, 'Saturation':{'power':list(frange(0.1,0.9,0.1))}} for col in cols}
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date',  'Social_MembershipDigital_Nextdoor_Spend']]
# MAGIC
...
## Saving Model ##
# transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Social.csv')
# transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_BuyingGroup_Social.csv')
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_NextDoorSpend_Social.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_NextDoorSpend_Social.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'Social_ASI_Meta_Spend', 'Social_IcmDigital_Facebook_Spend', 'Social_IcmSocial_FacebookAudienceNetwork_Spend', 'Social_IcmSocial_FacebookMessenger_Spend', 'Social_IcmSocial_Facebook_Spend',
 'Social_IcmSocial_Instagram_Spend', 'Social_IcmSocial_LinkedIn_Spend', 'Social_IcmSocial_Pinterest_Spend', 'Social_IcmSocial_TikTok_Spend', 'Social_IcmSocial_Twitter_Spend', 'Social_IcmSocial_messenger_Spend','Social_IcmSocial_unknown_Spend', 'Social_MediaCom_Meta_Spend', 'Social_MediaCom_TikTok_Spend', 'Social_MediaCom_X_Spend', 'Social_MembershipDigital_Facebook_Spend', 'Social_MembershipDigital_Instagram_Spend',
 'Social_MembershipDigital_Linkedin_Spend', 'Social_MembershipDigital_Nextdoor_Spend', 'Social_MembershipDigital_Reddit_Spend', 'Social_MembershipDigital_TikTok_Spend',
 'Social_ASI_Meta_Imps', 'Social_IcmDigital_Facebook_Imps', 'Social_IcmSocial_FacebookAudienceNetwork_Imps', 'Social_IcmSocial_FacebookMessenger_Imps', 'Social_IcmSocial_Facebook_Imps', 'Social_IcmSocial_Instagram_Imps',
 'Social_IcmSocial_LinkedIn_Imps', 'Social_IcmSocial_Pinterest_Imps', 'Social_IcmSocial_TikTok_Imps', 'Social_IcmSocial_Twitter_Imps', 'Social_IcmSocial_messenger_Imps', 'Social_IcmSocial_unknown_Imps',
 'Social_MediaCom_Meta_Imps', 'Social_MediaCom_TikTok_Imps', 'Social_MediaCom_X_Imps', 'Social_MembershipDigital_Facebook_Imps', 'Social_MembershipDigital_Instagram_Imps', 'Social_MembershipDigital_Linkedin_Imps',
 'Social_MembershipDigital_Nextdoor_Imps', 'Social_MembershipDigital_Reddit_Imps', 'Social_MembershipDigital_TikTok_Imps',
 'Social_ASI_Meta_Clicks', 'Social_IcmDigital_Facebook_Clicks', 'Social_IcmSocial_FacebookAudienceNetwork_Clicks', 'Social_IcmSocial_FacebookMessenger_Clicks', 'Social_IcmSocial_Facebook_Clicks', 'Social_IcmSocial_Instagram_Clicks', 'Social_IcmSocial_LinkedIn_Clicks', 'Social_IcmSocial_Pinterest_Clicks', 'Social_IcmSocial_TikTok_Clicks', 'Social_IcmSocial_Twitter_Clicks', 'Social_IcmSocial_messenger_Clicks',
 'Social_IcmSocial_unknown_Clicks', 'Social_MediaCom_Meta_Clicks', 'Social_MediaCom_TikTok_Clicks', 'Social_MediaCom_X_Clicks', 'Social_MembershipDigital_Facebook_Clicks', 'Social_MembershipDigital_Instagram_Clicks',
 'Social_MembershipDigital_Linkedin_Clicks', 'Social_MembershipDigital_Nextdoor_Clicks', 'Social_MembershipDigital_Reddit_Clicks', 'Social_MembershipDigital_TikTok_Clicks']
...
## Creating New Columns ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_Social.csv').drop('Unnamed: 0',axis=1)
transformed_df['Date'] = pd.to_datetime(transformed_df['Date'])
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Social.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_Social.csv').drop('Unnamed: 0',axis=1)
model_df.head()

# COMMAND ----------

# MAGIC %md
# MAGIC ## Appending Buying Group Level Data ##
...
## Creating New Columns ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_BuyingGroup_Social.csv').drop('Unnamed: 0',axis=1)
transformed_df['Date'] = pd.to_datetime(transformed_df['Date'])
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_BuyingGroup_Social.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_BuyingGroup_Social.csv').drop('Unnamed: 0',axis=1)
model_df.head()

# COMMAND ----------

# MAGIC %md
# MAGIC ## Appending Nextdoor Spend Transformation 
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_BuyingGroupNDnextdoorSpend_Social.csv')
## Reading Model ##
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_BuyingGroupNDnextdoorSpend_Social.csv').drop('Unnamed: 0',axis=1)
model_df.head()
