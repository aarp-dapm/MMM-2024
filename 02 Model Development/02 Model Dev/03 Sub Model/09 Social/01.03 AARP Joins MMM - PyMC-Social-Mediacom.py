...
for col in model_df.columns:
  if col.startswith('Social_MediaCom_') and col.split("_")[-1] in ['Spend', 'Imps', 'Clicks']:
    print(col)
...
model_cols = ['Social_MediaCom_Meta_Imps_AdStock6L1Wk90Ad_Power90', 'Social_MediaCom_TikTok_Imps_AdStock6L1Wk90Ad_Power90', 'Social_MediaCom_X_Imps_AdStock6L1Wk90Ad_Power90']

data_cols = [ 'Social_MediaCom_Meta_Spend', 'Social_MediaCom_TikTok_Spend', 'Social_MediaCom_X_Spend' ]
