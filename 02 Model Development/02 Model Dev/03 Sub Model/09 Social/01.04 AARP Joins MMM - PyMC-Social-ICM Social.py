...
model_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_BuyingGroup_Social.csv').drop('Unnamed: 0',axis=1).fillna(0)
model_df.head()
...
for col in model_df.columns:
  if col.startswith('Social_IcmSocial_') and col.split("_")[-1] in ['Spend', 'Imps', 'Clicks']:
    print(col)
...
model_cols = ['Social_IcmSocial_FacebookAudienceNetwork_Imps_AdStock6L1Wk90Ad_Power90', 'Social_IcmSocial_FacebookMessenger_Imps_AdStock6L1Wk90Ad_Power90', 'Social_IcmSocial_Facebook_Imps_AdStock6L1Wk90Ad_Power90', 'Social_IcmSocial_Instagram_Imps_AdStock6L1Wk90Ad_Power90', 'Social_IcmSocial_LinkedIn_Imps_AdStock6L1Wk90Ad_Power90', 'Social_IcmSocial_Pinterest_Imps_AdStock6L1Wk90Ad_Power90', 'Social_IcmSocial_TikTok_Imps_AdStock6L1Wk90Ad_Power90', 'Social_IcmSocial_Twitter_Imps_AdStock6L1Wk90Ad_Power90', 'Social_IcmSocial_messenger_Imps_AdStock6L1Wk90Ad_Power90', 'Social_IcmSocial_unknown_Imps_AdStock6L1Wk90Ad_Power90']

data_cols = [ 'Social_IcmSocial_FacebookAudienceNetwork_Spend', 'Social_IcmSocial_FacebookMessenger_Spend', 'Social_IcmSocial_Facebook_Spend', 'Social_IcmSocial_Instagram_Spend', 'Social_IcmSocial_LinkedIn_Spend', 'Social_IcmSocial_Pinterest_Spend', 'Social_IcmSocial_TikTok_Spend', 'Social_IcmSocial_Twitter_Spend', 'Social_IcmSocial_messenger_Spend', 'Social_IcmSocial_unknown_Spend' ]
...
with pm.Model(coords=coords) as varying_intercept:
       ...
       social_IcmSocial_Facebook_idx = pm.MutableData('social_IcmSocial_Facebook_idx', model_df['Social_IcmSocial_Facebook_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_IcmSocial_Instagram_idx = pm.MutableData('social_IcmSocial_Instagram_idx', model_df['Social_IcmSocial_Instagram_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_IcmSocial_LinkedIn_idx = pm.MutableData('social_IcmSocial_LinkedIn_idx', model_df['Social_IcmSocial_LinkedIn_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_IcmSocial_TikTok_idx = pm.MutableData('social_IcmSocial_TikTok_idx', model_df['Social_IcmSocial_TikTok_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       social_IcmSocial_FacebookAudienceNetwork_idx = pm.MutableData('social_IcmSocial_FacebookAudienceNetwork_idx', model_df['Social_IcmSocial_FacebookAudienceNetwork_Imps_AdStock6L1Wk90Ad_Power90'].values, dims='obs_id')
       ...
       beta_IcmSocial_Facebook_social =  pm.Uniform('beta_IcmSocial_Facebook_social', lower= 0.029*0.32*0.85 - 0.002,upper=0.029*0.32*0.85 + 0.002)
       beta_IcmSocial_Instagram_social =  pm.Uniform('beta_IcmSocial_Instagram_social', lower= 0.029*0.32*0.05 - 0.0002,upper=0.029*0.32*0.05 + 0.0002)
       beta_IcmSocial_LinkedIn_social =  pm.Uniform('beta_IcmSocial_LinkedIn_social', lower= 0.029*0.32*0.02 - 0.00005,upper=0.029*0.32*0.02 + 0.00005)
       beta_IcmSocial_TikTok_social =  pm.Uniform('beta_IcmSocial_TikTok_social', lower= 0.029*0.32*0.03 - 0.0001,upper=0.029*0.32*0.03 + 0.0001)
       beta_IcmSocial_FacebookAudienceNetwork_social =  pm.Uniform('beta_IcmSocial_FacebookAudienceNetwork_social', lower= 0.029*0.32*0.02 - 0.0001,upper=0.029*0.32*0.02 + 0.0001)
       ...
       y_hat = intercept_re[dma_idx] + beta_PromoEvnt_22MembDrive*PromoEvnt_22MembDrive_idx + beta_PromoEvnt_22BlackFriday*PromoEvnt_22BlackFriday_idx + beta_PromoEvnt_23MembDrive*PromoEvnt_23MembDrive_idx + beta_PromoEvnt_23BlackFriday*PromoEvnt_23BlackFriday_idx + beta_Seasonality_Mar*Seasonality_Mar_idx + beta_Seasonality_Apr*Seasonality_Apr_idx + beta_Seasonality_Feb*Seasonality_Feb_idx + beta_Seasonality_Dec*Seasonality_Dec_idx + beta_July0422_lag*July0422_lag_idx + beta_leadgen*leadgen_idx + beta_tv*tv_idx + beta_AltMedia*AltMedia_idx + beta_dm *dm_idx + beta_email*email_idx + beta_search*search_idx + beta_ASI_social*social_ASI_idx + beta_IcmDigital_social*social_IcmDigital_idx + beta_MembershipDigital_social*social_MembershipDigital_idx + beta_MediaCom_social*social_MediaCom_idx + beta_IcmSocial_Facebook_social*social_IcmSocial_Facebook_idx + beta_IcmSocial_Instagram_social*social_IcmSocial_Instagram_idx + beta_IcmSocial_LinkedIn_social*social_IcmSocial_LinkedIn_idx + beta_IcmSocial_TikTok_social*social_IcmSocial_TikTok_idx + beta_IcmSocial_FacebookAudienceNetwork_social*social_IcmSocial_FacebookAudienceNetwork_idx
...
# 'Social_MembershipDigital_Nextdoor_Imps_AdStock6L1Wk90Ad_Power90', 
