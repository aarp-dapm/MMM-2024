...
######### User Input Dict #############
#######################################
cols = ['TV_DRTV_ConnectedTV_Imps', 'TV_DRTV_LinearTV_Imps', 'TV_MediaCom_BrandTV_Imps', 'TV_MediaCom_NonBrandTV_Imps']
input_dict ={
  
  
  'TV_DRTV_ConnectedTV_Imps' : {'Adstock':{'week_cutoff':[6,13], 'peak_week':[1,2,3,4,5], 'decay_rate': list(frange(0.1,0.9,0.1))}, 'Saturation':{'power':list(frange(0.1,0.9,0.1))}},
  'TV_DRTV_LinearTV_Imps' : {'Adstock':{'week_cutoff':[6,13], 'peak_week':[1,2,3,4,5], 'decay_rate': list(frange(0.1,0.9,0.1))}, 'Saturation':{'power':list(frange(0.1,0.9,0.1))}},
  'TV_MediaCom_BrandTV_Imps' : {'Adstock':{'week_cutoff':[6,13], 'peak_week':[1,2,3,4,5], 'decay_rate': list(frange(0.1,0.9,0.1))}, 'Saturation':{'power':list(frange(0.1,0.9,0.1))}},
  'TV_MediaCom_NonBrandTV_Imps': {'Adstock':{'week_cutoff':[6,13], 'peak_week':[1,2,3,4,5], 'decay_rate': list(frange(0.1,0.9,0.1))}, 'Saturation':{'power':list(frange(0.1,0.9,0.1))}},
}
...
# MAGIC %time
# MAGIC
# MAGIC grouped_df = rawdata_df.groupby('DmaCode')[['Date','TV_DRTV_ConnectedTV_Imps', 'TV_DRTV_LinearTV_Imps', 'TV_MediaCom_BrandTV_Imps', 'TV_MediaCom_NonBrandTV_Imps']]
# MAGIC
...
## Saving Model ##
transformed_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_TV.csv')

## Reading Model ##
transformed_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/MMM_only_transformed_df_statsmodel_SubChannel_TV.csv').drop('Unnamed: 0',axis=1)
...
##############################################################
submodel_cols = ['DmaCode', 'Date', 'TV_DRTV_ConnectedTV_Spend', 'TV_DRTV_LinearTV_Spend', 'TV_MediaCom_BrandTV_Spend', 'TV_MediaCom_NonBrandTV_Spend', 'TV_DRTV_ConnectedTV_Imps', 'TV_DRTV_LinearTV_Imps', 'TV_MediaCom_BrandTV_Imps', 'TV_MediaCom_NonBrandTV_Imps', 'TV_DRTV_ConnectedTV_Clicks', 'TV_DRTV_LinearTV_Clicks', 'TV_MediaCom_BrandTV_Clicks', 'TV_MediaCom_NonBrandTV_Clicks']
...
## saving model dataframe ##
model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_updated_df_SubChannel_TV.csv')
## Reading Model ##
