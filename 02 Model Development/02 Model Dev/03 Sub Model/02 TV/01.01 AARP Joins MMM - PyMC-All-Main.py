...
data_cols = [
'TV_DRTV_ConnectedTV_Spend', 
'TV_DRTV_LinearTV_Spend', 


# 'TV_MediaCom_BrandTV_Spend', 
# 'TV_MediaCom_NonBrandTV_Spend'
'TV_MediaCom_BrandnNonBrandTV_Spend'
]
