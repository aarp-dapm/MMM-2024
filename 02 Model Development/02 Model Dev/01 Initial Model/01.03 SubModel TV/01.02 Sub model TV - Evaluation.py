...
contribution.to_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_TV_submodel_results.csv')

## Read Agg. Analysis Dataframe ##
contribution = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_TV_submodel_results.csv').drop('Unnamed: 0',axis=1)
...
## Model Creation ##
seasoanlity_vars =  [ 'Trend',  'Seasonality_Jan', 'Seasonality_Feb', 'Seasonality_Mar', 'Seasonality_Apr', 'Seasonality_May', 'Seasonality_Jun', 'Seasonality_Jul', 'Seasonality_Sep', 'Seasonality_Oct', 'Seasonality_Dec']
