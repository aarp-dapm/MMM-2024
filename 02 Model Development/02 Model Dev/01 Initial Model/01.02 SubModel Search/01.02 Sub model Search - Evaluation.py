...
# contribution.to_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_Search_submodel_results.csv')

# ## Read Agg. Analysis Dataframe ##
# contribution = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_Search_submodel_results.csv').drop('Unnamed: 0',axis=1)
...
media_vars = ['Video_Imps_AdStock6L4Wk30Ad_Power30', 'DirectMail_Imps_AdStock6L3Wk70Ad_Power90', 'AltMedia_Imps_AdStock6L3Wk90Ad_Power90']
