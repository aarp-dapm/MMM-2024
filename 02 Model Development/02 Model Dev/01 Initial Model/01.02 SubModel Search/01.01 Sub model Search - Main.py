...
## Saving File ##
# model_df.to_csv('/dbfs/blend360/sandbox/mmm/model/MMM_transformed_Search_SubModal_df.csv')
...
## Model Fit ##
model = smf.mixedlm("Search_contri_norm ~ {}".format(input_vars_str), data = model_df, groups =  'DmaCode').fit() ## Min-Max Normalization
...
# model_path = '/dbfs/blend360/sandbox/mmm/model/MMM_StatsModel_submodel_SearchVo2.pkl'
# model_path = '/dbfs/blend360/sandbox/mmm/model/MMM_StatsModel_submodel_SearchVo3.pkl'
# model_path = '/dbfs/blend360/sandbox/mmm/model/MMM_StatsModel_submodel_SearchVo4.pkl'
model_path = '/dbfs/blend360/sandbox/mmm/model/MMM_StatsModel_submodel_SearchVo5.pkl'
...
joins = model_df[['DmaCode', 'Date','Search_contri_norm']]
