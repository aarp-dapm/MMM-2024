...
# MAGIC %md
# MAGIC ### 2.2.1 Display Brand

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Display_Brand_Spend'
prospect_col = 'Display_Brand'
...
# MAGIC %md
# MAGIC ### 2.2.2 Social Brand

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Social_Brand_Spend'
prospect_col = 'Social_Brand'
...
# MAGIC %md
# MAGIC ### 2.2.3 Video Brand

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Video_Brand_Spend'
prospect_col = 'Video_Brand'
...
# MAGIC %md
# MAGIC ### 2.2.4 TV Brand

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'TV_Brand_Spend'
prospect_col = 'TV_Brand'
...
#####################################################################################
temp_df = df[df[spend_col]>0]
temp_df = temp_df[pd.to_datetime(temp_df['Date']).dt.year==2023]
temp_df.reset_index(inplace=True)
...
# MAGIC %md
# MAGIC ### 2.2.5 Search Brand

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Search_Brand_Spend'
prospect_col = 'Search_Brand'
...
## Saving Dataframe ##
param_df.to_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_optimization_brand_curves_params.csv')

## Reading Dataframe ##
param_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_optimization_brand_curves_params.csv').drop('Unnamed: 0',axis=1)
param_df.display()
