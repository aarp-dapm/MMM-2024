...
# MAGIC %md
# MAGIC ### 2.2.1 Print RemainingEM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Print_RemainingEM_Spend'
prospect_col = 'Print_RemainingEM'
...
# MAGIC %md
# MAGIC ### 2.2.2 TV RemainingEM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'TV_RemainingEM_Spend'
prospect_col = 'TV_RemainingEM'
...
#####################################################################################
#####################################################################################
temp_df = df[ (df[spend_col]>0) & (df['Date']>'2023-04-01')]
temp_df.reset_index(inplace=True)
...
# MAGIC %md
# MAGIC ### 2.2.3 Search RemainingEM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Search_RemainingEM_Spend'
prospect_col = 'Search_RemainingEM'
...
#####################################################################################
#####################################################################################
temp_df = df[ (df[spend_col]>0) & (pd.to_datetime(df['Date']).dt.year==2023) ]
temp_df.reset_index(inplace=True)
...
# MAGIC %md
# MAGIC ### 2.2.4 Social RemainingEM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Social_RemainingEM_Spend'
prospect_col = 'Social_RemainingEM'
...
#####################################################################################
#####################################################################################
temp_df = df[ (df[spend_col]>0) & (pd.to_datetime(df['Date']).dt.year==2023) & (df[prospect_col]<8) ]
temp_df.reset_index(inplace=True)
...
# MAGIC %md
# MAGIC ### 2.2.5 Display RemainingEM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Display_RemainingEM_Spend'
prospect_col = 'Display_RemainingEM'
...
# MAGIC %md
# MAGIC ### 2.2.6 Video RemainingEM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Video_RemainingEM_Spend'
prospect_col = 'Video_RemainingEM'
...
## Saving Dataframe ##
param_df.to_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_optimization_RemainingEM_curves_params.csv')

## Reading Dataframe ##
param_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_optimization_RemainingEM_curves_params.csv').drop('Unnamed: 0',axis=1)
param_df.display()
