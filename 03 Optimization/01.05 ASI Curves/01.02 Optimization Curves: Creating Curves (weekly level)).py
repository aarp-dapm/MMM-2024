...
# MAGIC %md
# MAGIC ### 2.2.1 Display ASI

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Display_ASI_Spend'
prospect_col = 'Display_ASI'
...
# MAGIC %md
# MAGIC ### 2.2.2 Social ASI

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Social_ASI_Spend'
prospect_col = 'Social_ASI'
...
# MAGIC %md
# MAGIC ### 2.2.3 Search ASI

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Search_ASI_Spend'
prospect_col = 'Search_ASI'
...
## Saving Dataframe ##
param_df.to_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_optimization_asi_curves_params.csv')

## Reading Dataframe ##
param_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_optimization_asi_curves_params.csv').drop('Unnamed: 0',axis=1)
param_df.display()
