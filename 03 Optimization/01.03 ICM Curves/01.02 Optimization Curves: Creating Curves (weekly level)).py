...
# MAGIC %md
# MAGIC ### 2.2.1 Display ICM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Display_ICM_Spend'
prospect_col = 'Display_ICM'
...
# MAGIC %md
# MAGIC ### 2.2.2 Search ICM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Search_ICM_Spend'
prospect_col = 'Search_ICM'
...
# MAGIC %md
# MAGIC ### 2.2.3 Social ICM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Social_ICM_Spend'
prospect_col = 'Social_ICM'
...
# MAGIC %md
# MAGIC ### 2.2.4 Video ICM

# COMMAND ----------

## Change it for Diff. Channels ##
spend_col = 'Video_ICM_Spend'
prospect_col = 'Video_ICM'
...
#####################################################################################
temp_df = df[df[spend_col]>0]
temp_df = temp_df[temp_df[prospect_col]>30]
temp_df.reset_index(inplace=True)
...
## Saving Dataframe ##
param_df.to_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_optimization_icm_curves_params.csv')

## Reading Dataframe ##
param_df = pd.read_csv('/dbfs/blend360/sandbox/mmm/model/mmm2_optimization_icm_curves_params.csv').drop('Unnamed: 0',axis=1)
param_df.display()
