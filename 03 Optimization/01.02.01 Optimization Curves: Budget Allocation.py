...
opt_param = {
              'DirectMail_Membership':   {'Total Spend': 52112911.35541834,   'Upper Bound':40,   'Lower Bound': -40}, 
              'AltMedia_Membership':     {'Total Spend': 50093326.45130657,   'Upper Bound':40,   'Lower Bound': -40}, 
              'LeadGen_Membership':      {'Total Spend': 23149207.0,          'Upper Bound':40,   'Lower Bound': -40}, 
              'Email_Membership':        {'Total Spend': 17852147.326496422,  'Upper Bound':40,   'Lower Bound': -40}, 
              'Display_Membership':      {'Total Spend': 6179189.19883013,    'Upper Bound':40,   'Lower Bound': -40}, 
              'Search_Membership':       {'Total Spend': 22028026.85855786,   'Upper Bound':0,   'Lower Bound': 0}, 
              'Social_Membership':       {'Total Spend': 21836602.231147,     'Upper Bound':40,   'Lower Bound': -40}, 
              'TV_Membership':           {'Total Spend': 15127078.156955216,  'Upper Bound':40,   'Lower Bound': -40},


              'Display_ICM':   {'Total Spend': 1785556.2832789824,   'Upper Bound':ub,   'Lower Bound': lb}, 
              'Search_ICM':    {'Total Spend': 6896452.472262759,    'Upper Bound':ub,   'Lower Bound': lb}, 
              'Social_ICM':    {'Total Spend': 14619418.366258431,   'Upper Bound':ub,   'Lower Bound': lb}, 
              'Video_ICM':     {'Total Spend': 1503818.1578639755,   'Upper Bound':ub,   'Lower Bound': lb},


              'Display_Brand':    {'Total Spend': 4179305.159738069,     'Upper Bound':ub,   'Lower Bound': lb}, 
              'Social_Brand':     {'Total Spend': 2984558.145521847,     'Upper Bound':ub,   'Lower Bound': lb}, 
              'Video_Brand':      {'Total Spend': 13817339.29961512,     'Upper Bound':ub,   'Lower Bound': lb}, 
              'TV_Brand':         {'Total Spend': 43505699.74999999,     'Upper Bound':ub,   'Lower Bound': lb}, 
              'Search_Brand':     {'Total Spend': 1242234.3904006367,    'Upper Bound':ub,   'Lower Bound': lb}, 


              'Display_ASI':   {'Total Spend': 2631859.4087892314,   'Upper Bound':ub,   'Lower Bound': lb}, 
              'Social_ASI':    {'Total Spend': 4437897.12118652,     'Upper Bound':ub,   'Lower Bound': lb}, 
              'Search_ASI':    {'Total Spend': 4632680.48,           'Upper Bound':ub,   'Lower Bound': lb},

              'Print_RemainingEM':          {'Total Spend': 161126.56,                  'Upper Bound':ub,   'Lower Bound': lb}, 
              'TV_RemainingEM':             {'Total Spend': 1600212.25,                 'Upper Bound':ub,   'Lower Bound': lb}, 
              'Search_RemainingEM':         {'Total Spend': 1125171.890082923,          'Upper Bound':ub,   'Lower Bound': lb}, 
              'Social_RemainingEM':         {'Total Spend': 524523.1399980248,          'Upper Bound':ub,   'Lower Bound': lb}, 
              'Display_RemainingEM':        {'Total Spend': 3394329.087609186,          'Upper Bound':ub,   'Lower Bound': lb}, 
              'Video_RemainingEM':          {'Total Spend': 4076713.431621416,          'Upper Bound':ub,   'Lower Bound': lb}
...
constraint = LinearConstraint(np.ones(num_channels), lb = total_spend, ub = total_spend)
...
### Objective Function ###
res = minimize( objective_function, method='trust-constr', x0=initial_spend, constraints=constraint, bounds=bounds, options={'maxiter':800000, 'disp':True})
res.x
