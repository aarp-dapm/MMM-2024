...
analysis_df = model_df.groupby('Date')[target_col+model_cols].sum().reset_index()
analysis_df.display()
...
# MAGIC %md
# MAGIC ### 3.02 Adding  Reg Wall, Trend, Promo, Holiday and splitting Chnnels into membership and non Membership
...
'TV_Membership_Imps_AdStock6L2Wk70Ad_Power70',
...
'LeadGen_Membership_Imps_AdStock6L1Wk60Ad_Power80',
'Email_Membership_Spend_AdStock6L1Wk30Ad_Power90',

'DirectMail_Membership_Imps_AdStock6L3Wk70Ad_Power90',
'AltMedia_Membership_Imps_AdStock6L3Wk90Ad_Power90',


### Non Membership Channels #### 
'TV_NonMembership_Imps_AdStock6L2Wk70Ad_Power70',
...
'Video_NonMembership_Imps_AdStock6L4Wk30Ad_Power30'
...
# MAGIC %md
# MAGIC ### 3.03 Removing Video and Direct Mail
...
# MAGIC %md
# MAGIC ### 3.04 Adding Seaosnality Cos3 and Cos7
...
# MAGIC %md
# MAGIC ### 3.05 Dropping Display Non Membership
...
# MAGIC %md
# MAGIC ### 3.06 Increasing Saturation of Membership Channels
...
# MAGIC %md
# MAGIC ### 3.07 Bringing Back Join Model
...
# MAGIC %md
# MAGIC ### 3.08 Adding back Trend Variable and dropping Reg Wall 
...
# MAGIC %md
# MAGIC ### 3.09 Dropping Alt Media and Updating TV to Lag 1
...
# MAGIC %md
# MAGIC ### 3.10 Clubbing Back Social to One Single Variable
...
# MAGIC %md
# MAGIC ### 3.11 Taking Data only where reg wall is present 
...
# MAGIC %md
# MAGIC ### 3.11 For filtered data: Creating Model with Social, Search and Video 
...
model_path = '/dbfs/blend360/sandbox/mmm/model/MMM_StatsModel_Reg_Vo11.pkl'
