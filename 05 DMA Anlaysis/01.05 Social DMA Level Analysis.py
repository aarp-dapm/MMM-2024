...
with pm.Model(coords=coords) as varying_intercept:
       ...
       ## Randomizing TV ##
       mu_re_ch = pm.Normal('mu_re_ch', mu=0.029, sigma=0.1)
       ...
       beta_social_re = pm.Normal('beta_social_re', mu = mu_re_ch, sigma=sigma_re_ch, dims='DmaCodes')      # beta_social =  pm.Normal('beta_social', mu= 0.029,sigma=0.007)     
