...
with pm.Model(coords=coords) as varying_intercept:
       ...
       ## Randomizing TV ##
       mu_re_ch = pm.Normal('mu_re_ch', mu=0.084, sigma=0.1)
       sigma_re_ch = pm.Exponential('sigma_re_ch',0.004)
       ...
       beta_AltMedia_re = pm.Normal('beta_AltMedia_re', mu = mu_re_ch, sigma=sigma_re_ch, dims='DmaCodes')   #  beta_AltMedia = pm.Normal('beta_AltMedia', mu= 0.084,sigma=0.004)  
...
plt.axhline(y=0.084, color = 'r', linestyle= '--', label = 'Prior')
