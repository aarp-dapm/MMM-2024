...
with pm.Model(coords=coords) as varying_intercept:
       ...
       ## Randomizing TV ##
       mu_re_ch = pm.Normal('mu_re_ch', mu=0.037, sigma=0.1)
       sigma_re_ch = pm.Exponential('sigma_re_ch',0.005)
       beta_tv_re = pm.Normal('beta_tv_re', mu = mu_re_ch, sigma=sigma_re_ch, dims='DmaCodes')      # beta_tv =    pm.Normal('beta_tv', mu= 0.037,sigma=0.005)  
...
plt.axhline(y=0.037, color = 'r', linestyle= '--', label = 'Prior')
