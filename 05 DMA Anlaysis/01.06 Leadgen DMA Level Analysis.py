...
with pm.Model(coords=coords) as varying_intercept:
       ...
       ## Randomizing LeadGen ##
       mu_re_ch = pm.Normal('mu_re_ch', mu=0.21, sigma=0.1)
       sigma_re_ch = pm.Exponential('sigma_re_ch',0.007)
       ...
       beta_leadgen_re = pm.Normal('beta_leadgen_re', mu = mu_re_ch, sigma=sigma_re_ch, dims='DmaCodes')      # beta_leadgen =  pm.Normal('beta_leadgen', mu= 0.21,sigma=0.007)      
...
plt.axhline(y=0.21, color = 'r', linestyle= '--', label = 'Prior')
