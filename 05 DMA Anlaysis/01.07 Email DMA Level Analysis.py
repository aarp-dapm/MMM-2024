...
with pm.Model(coords=coords) as varying_intercept:
       ...
       ## Randomizing Email ##
       mu_re_ch = pm.Normal('mu_re_ch', mu=0.059, sigma=0.1)
       sigma_re_ch = pm.Exponential('sigma_re_ch',0.006)
       ...
       beta_email_re = pm.Normal('beta_email_re', mu = mu_re_ch, sigma=sigma_re_ch, dims='DmaCodes')      # beta_email = pm.Normal('beta_email', mu= 0.059,sigma=0.006)        
...
plt.axhline(y=0.059, color = 'r', linestyle= '--', label = 'Prior')
